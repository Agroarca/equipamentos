import{d as Xe,r as Ft,o as de,c as cr,w as ra,k as Ae,l as ia,T as oa,a as Ie,j as sa,G as aa,x as ur,J as xn,H as ca,t as Dn,I as ua,F as la,m as ha,K as fa,L as da,f as pa,C as ga}from"./app-69f44fa6.js";import{r as Ye,t as Pe}from"./index-ac617c56.js";const va={key:0,class:"loader"},ya=Ie("div",{class:"elemento"},null,-1),ma=[ya],Oh=Xe({__name:"Loader",setup(t){const n=Ft(!1);function o(){n.value=!0}function a(){n.value=!1}return window.loader={show:o,hide:a,active:n},(c,h)=>(de(),cr(oa,{name:"loader",duration:"300"},{default:ra(()=>[n.value?(de(),Ae("div",va,ma)):ia("",!0)]),_:1}))}});/**
 * @license
