 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oc{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(o=>{if(sc(o)){const a=o.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(o=>o).join(" ")}}function sc(n){const t=n.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Rt="@firebase/app",Bn="0.9.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qc(n){se(new Z("platform-logger",t=>new oc(t),"PRIVATE")),se(new Z("heartbeat",t=>new Hc(t),"PRIVATE")),Q(Rt,Bn,n),Q(Rt,Bn,"esm2017"),Q("fire-js","")}qc("");var zc="firebase",Vc="9.17.2";/**
 * @license
