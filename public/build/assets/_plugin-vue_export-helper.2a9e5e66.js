 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lc{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(o=>{if(hc(o)){const a=o.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(o=>o).join(" ")}}function hc(r){const t=r.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Ot="@firebase/app",jn="0.9.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gc(r){se(new Z("platform-logger",t=>new lc(t),"PRIVATE")),se(new Z("heartbeat",t=>new Vc(t),"PRIVATE")),Q(Ot,jn,r),Q(Ot,jn,"esm2017"),Q("fire-js","")}Gc("");var Jc="firebase",Xc="9.17.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(Jc,Xc,"app");const br="@firebase/installations",$t="0.6.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kl(r,t){const o=t.data;if(!o.isFirebaseMessaging)return;r.onMessageHandler&&o.messageType===Ne.PUSH_RECEIVED&&(typeof r.onMessageHandler=="function"?r.onMessageHandler(Yn(o)):r.onMessageHandler.next(Yn(o)));const a=o.data;Fl(a)&&a[bl]==="1"&&await Vl(r,o.messageType,a)}const Qn="@firebase/messaging",Zn="0.12.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
