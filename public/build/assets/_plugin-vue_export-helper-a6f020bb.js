import{d as Xe,r as Ft,o as de,c as cr,w as ra,k as Ae,l as ia,T as oa,a as Ie,j as sa,G as aa,x as ur,J as xn,H as ca,t as Dn,I as ua,F as la,m as ha,K as fa,L as da,f as pa,C as ga}from"./app-b63c9c9f.js";import{r as Ye,t as Pe}from"./index-ac617c56.js";const va={key:0,class:"loader"},ya=Ie("div",{class:"elemento"},null,-1),ma=[ya],Oh=Xe({__name:"Loader",setup(t){const n=Ft(!1);function o(){n.value=!0}function a(){n.value=!1}return window.loader={show:o,hide:a,active:n},(c,h)=>(de(),cr(oa,{name:"loader",duration:"300"},{default:ra(()=>[n.value?(de(),Ae("div",va,ma)):ia("",!0)]),_:1}))}});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=1e4,kr=`w:${qt}`,Tr="FIS_v2",qc="https://firebaseinstallations.googleapis.com/v1",zc=60*60*1e3,Wc="installations",Vc="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _u(t){const n=t,{installationEntry:o,registrationPromise:a}=await Wt(n);return a?a.catch(console.error):Vt(n).catch(console.error),o.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wu(t,n=!1){const o=t;return await Su(o),(await Vt(o,n)).token}async function Su(t){const{registrationPromise:n}=await Wt(t);n&&await n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xu(){if(Ht())try{await $t()}catch(t){return U.warn(W.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return U.warn(W.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Yu(t,n,o,a,c,h,f){var p;const g=Wu(t);g.then(k=>{o[k.measurementId]=k.appId,t.options.measurementId&&k.measurementId!==t.options.measurementId&&U.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${k.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(k=>U.error(k)),n.push(g);const w=Xu().then(k=>{if(k)return a.getId()}),[_,E]=await Promise.all([g,w]);Bu(h)||Du(h,_.measurementId),c("js",new Date);const T=(p=f==null?void 0:f.config)!==null&&p!==void 0?p:{};return T[Pu]="firebase",T.update=!0,E!=null&&(T[Au]=E),c("config",_.measurementId,T),_.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qu{constructor(n){this.app=n}_delete(){return delete Ee[this.app.options.appId],Promise.resolve()}}let Ee={},zn=[];const Wn={};let Tt="dataLayer",Zu="gtag",Vn,qr,Kn=!1;function el(){const t=[];if(Oa()&&t.push("This is a browser extension environment."),dr()||t.push("Cookies are not available."),t.length>0){const n=t.map((a,c)=>`(${c+1}) ${a}`).join(" "),o=W.create("invalid-analytics-context",{errorInfo:n});U.warn(o.message)}}function tl(t,n,o){el();const a=t.options.appId;if(!a)throw W.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)U.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw W.create("no-api-key");if(Ee[a]!=null)throw W.create("already-exists",{id:a});if(!Kn){Ru(Tt);const{wrappedGtag:h,gtagCore:f}=Mu(Ee,zn,Wn,Tt,Zu);qr=h,Vn=f,Kn=!0}return Ee[a]=Yu(t,zn,Wn,n,Vn,Tt,o),new Qu(t)}function nl(t=mr()){t=Qe(t);const n=Re(t,ze);return n.isInitialized()?n.getImmediate():rl(t)}function rl(t,n={}){const o=Re(t,ze);if(o.isInitialized()){const c=o.getImmediate();if($e(n,o.getOptions()))return c;throw W.create("already-initialized")}return o.initialize({options:n})}function il(t,n,o,a){t=Qe(t),Ju(qr,Ee[t.app.options.appId],n,o,a).catch(c=>U.error(c))}const Gn="@firebase/analytics",Jn="0.9.4";function ol(){oe(new Q(ze,(n,{options:o})=>{const a=n.getProvider("app").getImmediate(),c=n.getProvider("installations-internal").getImmediate();return tl(a,c,o)},"PUBLIC")),oe(new Q("analytics-internal",t,"PRIVATE")),Y(Gn,Jn),Y(Gn,Jn,"esm2017");function t(n){try{const o=n.getProvider(ze).getImmediate();return{logEvent:(a,c,h)=>il(o,a,c,h)}}catch(o){throw W.create("interop-component-reg-failed",{reason:o})}}}ol();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sl="/firebase-messaging-sw.js",al="/firebase-cloud-messaging-push-scope",zr="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",cl="https://fcmregistrations.googleapis.com/v1",Wr="google.c.a.c_id",ul="google.c.a.c_l",ll="google.c.a.ts",hl="google.c.a.e";var Xn;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Xn||(Xn={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl=7*24*60*60*1e3;async function kl(t){const n=await Il(t.swRegistration,t.vapidKey),o={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:n.endpoint,auth:re(n.getKey("auth")),p256dh:re(n.getKey("p256dh"))},a=await Vr(t.firebaseDependencies);if(a){if(El(a.subscriptionOptions,o))return Date.now()>=a.createTime+Sl?Cl(t,{token:a.token,createTime:Date.now(),subscriptionOptions:o}):a.token;try{await Kr(t.firebaseDependencies,a.token)}catch(c){console.warn(c)}return Qn(t.firebaseDependencies,o)}else return Qn(t.firebaseDependencies,o)}async function Tl(t){const n=await Vr(t.firebaseDependencies);n&&(await Kr(t.firebaseDependencies,n.token),await ml(t.firebaseDependencies));const o=await t.swRegistration.pushManager.getSubscription();return o?o.unsubscribe():!0}async function Cl(t,n){try{const o=await wl(t.firebaseDependencies,n),a=Object.assign(Object.assign({},n),{token:o,createTime:Date.now()});return await Gt(t.firebaseDependencies,a),o}catch(o){throw await Tl(t),o}}async function Qn(t,n){const a={token:await _l(t,n),createTime:Date.now(),subscriptionOptions:n};return await Gt(t,a),a.token}async function Il(t,n){const o=await t.pushManager.getSubscription();return o||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:fl(n)})}function El(t,n){const o=n.vapidKey===t.vapidKey,a=n.endpoint===t.endpoint,c=n.auth===t.auth,h=n.p256dh===t.p256dh;return o&&a&&c&&h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xl(t){return typeof t=="object"&&!!t&&Wr in t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ml(t,n,o){const a=Bl(n);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(a,{message_id:o[Wr],message_name:o[ul],message_time:o[ll],message_device_time:Math.floor(Date.now()/1e3)})}function Bl(t){switch(t){case xe.NOTIFICATION_CLICKED:return"notification_open";case xe.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
