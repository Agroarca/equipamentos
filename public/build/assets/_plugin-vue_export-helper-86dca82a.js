import{d as Ye,r as Ht,o as de,c as lr,w as oa,k as Ae,l as sa,T as aa,a as Ie,j as ca,G as ua,x as hr,J as Rn,H as la,t as Nn,I as ha,F as fa,m as da,K as pa,L as ga,f as va,C as ya}from"./app-de2de5be.js";import{r as Qe,t as Pe}from"./index-ac617c56.js";const ma={key:0,class:"loader"},ba=Ie("div",{class:"elemento"},null,-1),_a=[ba],Nh=Ye({__name:"Loader",setup(t){const n=Ht(!1);function o(){n.value=!0}function a(){n.value=!1}return window.loader={show:o,hide:a,active:n},(c,h)=>(de(),lr(aa,{name:"loader",duration:"300"},{default:oa(()=>[n.value?(de(),Ae("div",ma,_a)):sa("",!0)]),_:1}))}});/**
 * @license
