var ia=Object.defineProperty;var oa=(n,t,o)=>t in n?ia(n,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[t]=o;var R=(n,t,o)=>(oa(n,typeof t!="symbol"?t+"":t,o),o);import{d as Ze,m as Ht,o as pe,a as cr,w as sa,i as Re,k as aa,T as ca,b as Pe,A as ua,B as la,n as ur,J as xn,C as ha,t as Dn,D as fa,F as da,r as pa,E as ga,G as va,g as ya,x as ma}from"./app.c3c88734.js";import{r as et,t as Ne}from"./index.c57ba517.js";const ba={key:0,class:"loader"},_a=Pe("div",{class:"elemento"},null,-1),wa=[_a],Dh=Ze({__name:"Loader",setup(n){const t=Ht(!1);function o(){t.value=!0}function a(){t.value=!1}return window.loader={show:o,hide:a,active:t},(c,h)=>(pe(),cr(ca,{name:"loader",duration:"300"},{default:sa(()=>[t.value?(pe(),Re("div",ba,wa)):aa("",!0)]),_:1}))}});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ia=()=>Ca().__FIREBASE_DEFAULTS__,Ea=()=>{if(typeof process>"u"||typeof process.env>"u")return;const n={}.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Aa=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&Ta(n[1]);return t&&JSON.parse(t)},Pa=()=>{try{return Ia()||Ea()||Aa()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},Oa=()=>{var n;return(n=Pa())===null||n===void 0?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xa{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,o)=>{this.resolve=t,this.reject=o})}wrapCallback(t){return(o,a)=>{o?this.reject(o):this.resolve(a),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(o):t(o,a))}}}function Da(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function $t(){try{return typeof indexedDB=="object"}catch{return!1}}function Ut(){return new Promise((n,t)=>{try{let o=!0;const a="validate-browser-context-for-indexeddb-analytics-module",c=self.indexedDB.open(a);c.onsuccess=()=>{c.result.close(),o||self.indexedDB.deleteDatabase(a),n(!0)},c.onupgradeneeded=()=>{o=!1},c.onerror=()=>{var h;t(((h=c.error)===null||h===void 0?void 0:h.message)||"")}}catch(o){t(o)}})}function dr(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ra="FirebaseError";class be extends Error{constructor(t,o,a){super(o),this.code=t,this.customData=a,this.name=Ra,Object.setPrototypeOf(this,be.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Me.prototype.create)}}class Me{constructor(t,o,a){this.service=t,this.serviceName=o,this.errors=a}create(t,...o){const a=o[0]||{},c=`${this.service}/${t}`,h=this.errors[t],f=h?Na(h,a):"Error",p=`${this.serviceName}: ${f} (${c}).`;return new be(c,p,a)}}function Na(n,t){return n.replace(La,(o,a)=>{const c=t[a];return c!=null?String(c):`<${a}?>`})}const La=/\{\$([^}]+)}/g;function We(n,t){if(n===t)return!0;const o=Object.keys(n),a=Object.keys(t);for(const c of o){if(!a.includes(c))return!1;const h=n[c],f=t[c];if(Rn(h)&&Rn(f)){if(!We(h,f))return!1}else if(h!==f)return!1}for(const c of a)if(!o.includes(c))return!1;return!0}function Rn(n){return n!==null&&typeof n=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ja=1e3,Ma=2,Ba=4*60*60*1e3,Fa=.5;function Nn(n,t=ja,o=Ma){const a=t*Math.pow(o,n),c=Math.round(Fa*a*(Math.random()-.5)*2);return Math.min(Ba,a+c)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(t,o){this.name=t,this.container=o,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const o=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(o)){const a=new xa;if(this.instancesDeferred.set(o,a),this.isInitialized(o)||this.shouldAutoInitialize())try{const c=this.getOrInitializeService({instanceIdentifier:o});c&&a.resolve(c)}catch{}}return this.instancesDeferred.get(o).promise}getImmediate(t){var o;const a=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),c=(o=t==null?void 0:t.optional)!==null&&o!==void 0?o:!1;if(this.isInitialized(a)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:a})}catch(h){if(c)return null;throw h}else{if(c)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Ua(t))try{this.getOrInitializeService({instanceIdentifier:fe})}catch{}for(const[o,a]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(o);try{const h=this.getOrInitializeService({instanceIdentifier:c});a.resolve(h)}catch{}}}}clearInstance(t=fe){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(o=>"INTERNAL"in o).map(o=>o.INTERNAL.delete()),...t.filter(o=>"_delete"in o).map(o=>o._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=fe){return this.instances.has(t)}getOptions(t=fe){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:o={}}=t,a=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(a))throw Error(`${this.name}(${a}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const c=this.getOrInitializeService({instanceIdentifier:a,options:o});for(const[h,f]of this.instancesDeferred.entries()){const p=this.normalizeInstanceIdentifier(h);a===p&&f.resolve(c)}return c}onInit(t,o){var a;const c=this.normalizeInstanceIdentifier(o),h=(a=this.onInitCallbacks.get(c))!==null&&a!==void 0?a:new Set;h.add(t),this.onInitCallbacks.set(c,h);const f=this.instances.get(c);return f&&t(f,c),()=>{h.delete(t)}}invokeOnInitCallbacks(t,o){const a=this.onInitCallbacks.get(o);if(!!a)for(const c of a)try{c(t,o)}catch{}}getOrInitializeService({instanceIdentifier:t,options:o={}}){let a=this.instances.get(t);if(!a&&this.component&&(a=this.component.instanceFactory(this.container,{instanceIdentifier:$a(t),options:o}),this.instances.set(t,a),this.instancesOptions.set(t,o),this.invokeOnInitCallbacks(a,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,a)}catch{}return a||null}normalizeInstanceIdentifier(t=fe){return this.component?this.component.multipleInstances?t:fe:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function $a(n){return n===fe?void 0:n}function Ua(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const o=this.getProvider(t.name);if(o.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);o.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const o=new Ha(t,this);return this.providers.set(t,o),o}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var x;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(x||(x={}));const za={debug:x.DEBUG,verbose:x.VERBOSE,info:x.INFO,warn:x.WARN,error:x.ERROR,silent:x.SILENT},Va=x.INFO,Wa={[x.DEBUG]:"log",[x.VERBOSE]:"log",[x.INFO]:"info",[x.WARN]:"warn",[x.ERROR]:"error"},Ka=(n,t,...o)=>{if(t<n.logLevel)return;const a=new Date().toISOString(),c=Wa[t];if(c)console[c](`[${a}]  ${n.name}:`,...o);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class pr{constructor(t){this.name=t,this._logLevel=Va,this._logHandler=Ka,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in x))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?za[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,x.DEBUG,...t),this._logHandler(this,x.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,x.VERBOSE,...t),this._logHandler(this,x.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,x.INFO,...t),this._logHandler(this,x.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,x.WARN,...t),this._logHandler(this,x.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,x.ERROR,...t),this._logHandler(this,x.ERROR,...t)}}const Ga=(n,t)=>t.some(o=>n instanceof o);let Ln,jn;function Ja(){return Ln||(Ln=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Xa(){return jn||(jn=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const gr=new WeakMap,xt=new WeakMap,vr=new WeakMap,bt=new WeakMap,qt=new WeakMap;function Ya(n){const t=new Promise((o,a)=>{const c=()=>{n.removeEventListener("success",h),n.removeEventListener("error",f)},h=()=>{o(oe(n.result)),c()},f=()=>{a(n.error),c()};n.addEventListener("success",h),n.addEventListener("error",f)});return t.then(o=>{o instanceof IDBCursor&&gr.set(o,n)}).catch(()=>{}),qt.set(t,n),t}function Qa(n){if(xt.has(n))return;const t=new Promise((o,a)=>{const c=()=>{n.removeEventListener("complete",h),n.removeEventListener("error",f),n.removeEventListener("abort",f)},h=()=>{o(),c()},f=()=>{a(n.error||new DOMException("AbortError","AbortError")),c()};n.addEventListener("complete",h),n.addEventListener("error",f),n.addEventListener("abort",f)});xt.set(n,t)}let Dt={get(n,t,o){if(n instanceof IDBTransaction){if(t==="done")return xt.get(n);if(t==="objectStoreNames")return n.objectStoreNames||vr.get(n);if(t==="store")return o.objectStoreNames[1]?void 0:o.objectStore(o.objectStoreNames[0])}return oe(n[t])},set(n,t,o){return n[t]=o,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function Za(n){Dt=n(Dt)}function ec(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...o){const a=n.call(_t(this),t,...o);return vr.set(a,t.sort?t.sort():[t]),oe(a)}:Xa().includes(n)?function(...t){return n.apply(_t(this),t),oe(gr.get(this))}:function(...t){return oe(n.apply(_t(this),t))}}function tc(n){return typeof n=="function"?ec(n):(n instanceof IDBTransaction&&Qa(n),Ga(n,Ja())?new Proxy(n,Dt):n)}function oe(n){if(n instanceof IDBRequest)return Ya(n);if(bt.has(n))return bt.get(n);const t=tc(n);return t!==n&&(bt.set(n,t),qt.set(t,n)),t}const _t=n=>qt.get(n);function nt(n,t,{blocked:o,upgrade:a,blocking:c,terminated:h}={}){const f=indexedDB.open(n,t),p=oe(f);return a&&f.addEventListener("upgradeneeded",g=>{a(oe(f.result),g.oldVersion,g.newVersion,oe(f.transaction))}),o&&f.addEventListener("blocked",()=>o()),p.then(g=>{h&&g.addEventListener("close",()=>h()),c&&g.addEventListener("versionchange",()=>c())}).catch(()=>{}),p}function wt(n,{blocked:t}={}){const o=indexedDB.deleteDatabase(n);return t&&o.addEventListener("blocked",()=>t()),oe(o).then(()=>{})}const nc=["get","getKey","getAll","getAllKeys","count"],rc=["put","add","delete","clear"],St=new Map;function Mn(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(St.get(t))return St.get(t);const o=t.replace(/FromIndex$/,""),a=t!==o,c=rc.includes(o);if(!(o in(a?IDBIndex:IDBObjectStore).prototype)||!(c||nc.includes(o)))return;const h=async function(f,...p){const g=this.transaction(f,c?"readwrite":"readonly");let w=g.store;return a&&(w=w.index(p.shift())),(await Promise.all([w[o](...p),c&&g.done]))[0]};return St.set(t,h),h}Za(n=>({...n,get:(t,o,a)=>Mn(t,o)||n.get(t,o,a),has:(t,o)=>!!Mn(t,o)||n.has(t,o)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ic{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(o=>{if(oc(o)){const a=o.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(o=>o).join(" ")}}function oc(n){const t=n.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Rt="@firebase/app",Bn="0.9.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mc=1024,Bc=30*24*60*60*1e3;class Fc{constructor(t){this.container=t,this._heartbeatsCache=null;const o=this.container.getProvider("app").getImmediate();this._storage=new $c(o),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),a=Hn();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===a||this._heartbeatsCache.heartbeats.some(c=>c.date===a)))return this._heartbeatsCache.heartbeats.push({date:a,agent:o}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(c=>{const h=new Date(c.date).valueOf();return Date.now()-h<=Bc}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Hn(),{heartbeatsToSend:o,unsentEntries:a}=Hc(this._heartbeatsCache.heartbeats),c=fr(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),c}}function Hn(){return new Date().toISOString().substring(0,10)}function Hc(n,t=Mc){const o=[];let a=n.slice();for(const c of n){const h=o.find(f=>f.agent===c.agent);if(h){if(h.dates.push(c.date),$n(o)>t){h.dates.pop();break}}else if(o.push({agent:c.agent,dates:[c.date]}),$n(o)>t){o.pop();break}a=a.slice(1)}return{heartbeatsToSend:o,unsentEntries:a}}class $c{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return $t()?Ut().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await jc(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(t){var o;if(await this._canUseIndexedDBPromise){const c=await this.read();return Fn(this.app,{lastSentHeartbeatDate:(o=t.lastSentHeartbeatDate)!==null&&o!==void 0?o:c.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var o;if(await this._canUseIndexedDBPromise){const c=await this.read();return Fn(this.app,{lastSentHeartbeatDate:(o=t.lastSentHeartbeatDate)!==null&&o!==void 0?o:c.lastSentHeartbeatDate,heartbeats:[...c.heartbeats,...t.heartbeats]})}else return}}function $n(n){return fr(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(n){se(new Z("platform-logger",t=>new ic(t),"PRIVATE")),se(new Z("heartbeat",t=>new Fc(t),"PRIVATE")),Q(Rt,Bn,n),Q(Rt,Bn,"esm2017"),Q("fire-js","")}Uc("");var qc="firebase",zc="9.17.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(qc,zc,"app");const wr="@firebase/installations",zt="0.6.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=1e4,kr=`w:${zt}`,Tr="FIS_v2",Vc="https://firebaseinstallations.googleapis.com/v1",Wc=60*60*1e3,Kc="installations",Gc="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zc({appConfig:n,heartbeatServiceProvider:t},{fid:o}){const a=Ir(n),c=Pr(n),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&c.append("x-firebase-client",w)}const f={fid:o,authVersion:Tr,appId:n.appId,sdkVersion:kr},p={method:"POST",headers:c,body:JSON.stringify(f)},g=await Or(()=>fetch(a,p));if(g.ok){const w=await g.json();return{fid:w.fid||o,registrationStatus:2,refreshToken:w.refreshToken,authToken:Er(w.authToken)}}else throw await Ar("Create Installation",g)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tu=/^[cdef][\w-]{21}$/,jt="";function nu(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const o=ru(n);return tu.test(o)?o:jt}catch{return jt}}function ru(n){return eu(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=new Map;function Rr(n,t){const o=rt(n);Nr(o,t),iu(o,t)}function Nr(n,t){const o=Dr.get(n);if(!!o)for(const a of o)a(t)}function iu(n,t){const o=ou();o&&o.postMessage({key:n,fid:t}),su()}let de=null;function ou(){return!de&&"BroadcastChannel"in self&&(de=new BroadcastChannel("[Firebase] FID Change"),de.onmessage=n=>{Nr(n.data.key,n.data.fid)}),de}function su(){Dr.size===0&&de&&(de.close(),de=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wt(n){let t;const o=await it(n.appConfig,a=>{const c=uu(a),h=lu(n,c);return t=h.registrationPromise,h.installationEntry});return o.fid===jt?{installationEntry:await t}:{installationEntry:o,registrationPromise:t}}function uu(n){const t=n||{fid:nu(),registrationStatus:0};return jr(t)}function lu(n,t){if(t.registrationStatus===0){if(!navigator.onLine){const c=Promise.reject(ve.create("app-offline"));return{installationEntry:t,registrationPromise:c}}const o={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},a=hu(n,o);return{installationEntry:o,registrationPromise:a}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:fu(n)}:{installationEntry:t}}async function hu(n,t){try{const o=await Zc(n,t);return Ge(n.appConfig,o)}catch(o){throw Cr(o)&&o.customData.serverCode===409?await Lr(n.appConfig):await Ge(n.appConfig,{fid:t.fid,registrationStatus:0}),o}}async function fu(n){let t=await Un(n.appConfig);for(;t.registrationStatus===1;)await xr(100),t=await Un(n.appConfig);if(t.registrationStatus===0){const{installationEntry:o,registrationPromise:a}=await Wt(n);return a||o}return t}function Un(n){return it(n,t=>{if(!t)throw ve.create("installation-not-found");return jr(t)})}function jr(n){return du(n)?{fid:n.fid,registrationStatus:0}:n}function du(n){return n.registrationStatus===1&&n.registrationTime+Sr<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pu({appConfig:n,heartbeatServiceProvider:t},o){const a=gu(n,o),c=Xc(n,o),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&c.append("x-firebase-client",w)}const f={installation:{sdkVersion:kr,appId:n.appId}},p={method:"POST",headers:c,body:JSON.stringify(f)},g=await Or(()=>fetch(a,p));if(g.ok){const w=await g.json();return Er(w)}else throw await Ar("Generate Auth Token",g)}function gu(n,{fid:t}){return`${Ir(n)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kt(n,t=!1){let o;const a=await it(n.appConfig,h=>{if(!Mr(h))throw ve.create("not-registered");const f=h.authToken;if(!t&&mu(f))return h;if(f.requestStatus===1)return o=vu(n,t),h;{if(!navigator.onLine)throw ve.create("app-offline");const p=_u(h);return o=yu(n,p),p}});return o?await o:a.authToken}async function vu(n,t){let o=await qn(n.appConfig);for(;o.authToken.requestStatus===1;)await xr(100),o=await qn(n.appConfig);const a=o.authToken;return a.requestStatus===0?Kt(n,t):a}function qn(n){return it(n,t=>{if(!Mr(t))throw ve.create("not-registered");const o=t.authToken;return wu(o)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function yu(n,t){try{const o=await pu(n,t),a=Object.assign(Object.assign({},t),{authToken:o});return await Ge(n.appConfig,a),o}catch(o){if(Cr(o)&&(o.customData.serverCode===401||o.customData.serverCode===404))await Lr(n.appConfig);else{const a=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await Ge(n.appConfig,a)}throw o}}function Mr(n){return n!==void 0&&n.registrationStatus===2}function mu(n){return n.requestStatus===2&&!bu(n)}function bu(n){const t=Date.now();return t<n.creationTime||n.creationTime+n.expiresIn<t+Wc}function _u(n){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:t})}function wu(n){return n.requestStatus===1&&n.requestTime+Sr<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Su(n){const t=n,{installationEntry:o,registrationPromise:a}=await Wt(t);return a?a.catch(console.error):Kt(t).catch(console.error),o.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ku(n,t=!1){const o=n;return await Tu(o),(await Kt(o,t)).token}async function Tu(n){const{registrationPromise:t}=await Wt(n);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cu(n){if(!n||!n.options)throw Ct("App Configuration");if(!n.name)throw Ct("App Name");const t=["projectId","apiKey","appId"];for(const o of t)if(!n.options[o])throw Ct(o);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Ct(n){return ve.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Br="installations",Iu="installations-internal",Eu=n=>{const t=n.getProvider("app").getImmediate(),o=Cu(t),a=Be(t,"heartbeat");return{app:t,appConfig:o,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},Au=n=>{const t=n.getProvider("app").getImmediate(),o=Be(t,Br).getImmediate();return{getId:()=>Su(o),getToken:c=>ku(o,c)}};function Pu(){se(new Z(Br,Eu,"PUBLIC")),se(new Z(Iu,Au,"PRIVATE"))}Pu();Q(wr,zt);Q(wr,zt,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="analytics",Ou="firebase_id",xu="origin",Du=60*1e3,Ru="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Fr="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(n){return Promise.all(n.map(t=>t.catch(o=>o)))}function Nu(n,t){const o=document.createElement("script");o.src=`${Fr}?l=${n}&id=${t}`,o.async=!0,document.head.appendChild(o)}function Lu(n){let t=[];return Array.isArray(window[n])?t=window[n]:window[n]=t,t}async function ju(n,t,o,a,c,h){const f=a[c];try{if(f)await t[f];else{const g=(await Hr(o)).find(w=>w.measurementId===c);g&&await t[g.appId]}}catch(p){q.error(p)}n("config",c,h)}async function Mu(n,t,o,a,c){try{let h=[];if(c&&c.send_to){let f=c.send_to;Array.isArray(f)||(f=[f]);const p=await Hr(o);for(const g of f){const w=p.find(E=>E.measurementId===g),_=w&&t[w.appId];if(_)h.push(_);else{h=[];break}}}h.length===0&&(h=Object.values(t)),await Promise.all(h),n("event",a,c||{})}catch(h){q.error(h)}}function Bu(n,t,o,a){async function c(h,f,p){try{h==="event"?await Mu(n,t,o,f,p):h==="config"?await ju(n,t,o,a,f,p):h==="consent"?n("consent","update",p):n("set",f)}catch(g){q.error(g)}}return c}function Fu(n,t,o,a,c){let h=function(...f){window[a].push(arguments)};return window[c]&&typeof window[c]=="function"&&(h=window[c]),window[c]=Bu(h,n,t,o),{gtagCore:h,wrappedGtag:window[c]}}function Hu(n){const t=window.document.getElementsByTagName("script");for(const o of Object.values(t))if(o.src&&o.src.includes(Fr)&&o.src.includes(n))return o;return null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uu=30,qu=1e3;class zu{constructor(t={},o=qu){this.throttleMetadata=t,this.intervalMillis=o}getThrottleMetadata(t){return this.throttleMetadata[t]}setThrottleMetadata(t,o){this.throttleMetadata[t]=o}deleteThrottleMetadata(t){delete this.throttleMetadata[t]}}const $r=new zu;function Vu(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function Wu(n){var t;const{appId:o,apiKey:a}=n,c={method:"GET",headers:Vu(a)},h=Ru.replace("{app-id}",o),f=await fetch(h,c);if(f.status!==200&&f.status!==304){let p="";try{const g=await f.json();!((t=g.error)===null||t===void 0)&&t.message&&(p=g.error.message)}catch{}throw W.create("config-fetch-failed",{httpStatus:f.status,responseMessage:p})}return f.json()}async function Ku(n,t=$r,o){const{appId:a,apiKey:c,measurementId:h}=n.options;if(!a)throw W.create("no-app-id");if(!c){if(h)return{measurementId:h,appId:a};throw W.create("no-api-key")}const f=t.getThrottleMetadata(a)||{backoffCount:0,throttleEndTimeMillis:Date.now()},p=new Xu;return setTimeout(async()=>{p.abort()},o!==void 0?o:Du),Ur({appId:a,apiKey:c,measurementId:h},f,p,t)}async function Ur(n,{throttleEndTimeMillis:t,backoffCount:o},a,c=$r){var h;const{appId:f,measurementId:p}=n;try{await Gu(a,t)}catch(g){if(p)return q.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${p} provided in the "measurementId" field in the local Firebase config. [${g==null?void 0:g.message}]`),{appId:f,measurementId:p};throw g}try{const g=await Wu(n);return c.deleteThrottleMetadata(f),g}catch(g){const w=g;if(!Ju(w)){if(c.deleteThrottleMetadata(f),p)return q.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${p} provided in the "measurementId" field in the local Firebase config. [${w==null?void 0:w.message}]`),{appId:f,measurementId:p};throw g}const _=Number((h=w==null?void 0:w.customData)===null||h===void 0?void 0:h.httpStatus)===503?Nn(o,c.intervalMillis,Uu):Nn(o,c.intervalMillis),E={throttleEndTimeMillis:Date.now()+_,backoffCount:o+1};return c.setThrottleMetadata(f,E),q.debug(`Calling attemptFetch again in ${_} millis`),Ur(n,E,a,c)}}function Gu(n,t){return new Promise((o,a)=>{const c=Math.max(t-Date.now(),0),h=setTimeout(o,c);n.addEventListener(()=>{clearTimeout(h),a(W.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}function Ju(n){if(!(n instanceof be)||!n.customData)return!1;const t=Number(n.customData.httpStatus);return t===429||t===500||t===503||t===504}class Xu{constructor(){this.listeners=[]}addEventListener(t){this.listeners.push(t)}abort(){this.listeners.forEach(t=>t())}}async function Yu(n,t,o,a,c){if(c&&c.global){n("event",o,a);return}else{const h=await t,f=Object.assign(Object.assign({},a),{send_to:h});n("event",o,f)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class el{constructor(t){this.app=t}_delete(){return delete Oe[this.app.options.appId],Promise.resolve()}}let Oe={},zn=[];const Vn={};let It="dataLayer",tl="gtag",Wn,qr,Kn=!1;function nl(){const n=[];if(Da()&&n.push("This is a browser extension environment."),dr()||n.push("Cookies are not available."),n.length>0){const t=n.map((a,c)=>`(${c+1}) ${a}`).join(" "),o=W.create("invalid-analytics-context",{errorInfo:t});q.warn(o.message)}}function rl(n,t,o){nl();const a=n.options.appId;if(!a)throw W.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)q.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw W.create("no-api-key");if(Oe[a]!=null)throw W.create("already-exists",{id:a});if(!Kn){Lu(It);const{wrappedGtag:h,gtagCore:f}=Fu(Oe,zn,Vn,It,tl);qr=h,Wn=f,Kn=!0}return Oe[a]=Zu(n,zn,Vn,t,Wn,It,o),new el(n)}function il(n=mr()){n=tt(n);const t=Be(n,Je);return t.isInitialized()?t.getImmediate():ol(n)}function ol(n,t={}){const o=Be(n,Je);if(o.isInitialized()){const c=o.getImmediate();if(We(t,o.getOptions()))return c;throw W.create("already-initialized")}return o.initialize({options:t})}function sl(n,t,o,a){n=tt(n),Yu(qr,Oe[n.app.options.appId],t,o,a).catch(c=>q.error(c))}const Gn="@firebase/analytics",Jn="0.9.3";function al(){se(new Z(Je,(t,{options:o})=>{const a=t.getProvider("app").getImmediate(),c=t.getProvider("installations-internal").getImmediate();return rl(a,c,o)},"PUBLIC")),se(new Z("analytics-internal",n,"PRIVATE")),Q(Gn,Jn),Q(Gn,Jn,"esm2017");function n(t){try{const o=t.getProvider(Je).getImmediate();return{logEvent:(a,c,h)=>sl(o,a,c,h)}}catch(o){throw W.create("interop-component-reg-failed",{reason:o})}}}al();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl="/firebase-messaging-sw.js",ul="/firebase-cloud-messaging-push-scope",zr="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",ll="https://fcmregistrations.googleapis.com/v1",Vr="google.c.a.c_id",hl="google.c.a.c_l",fl="google.c.a.ts",dl="google.c.a.e";var Xn;(function(n){n[n.DATA_MESSAGE=1]="DATA_MESSAGE",n[n.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Xn||(Xn={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ie(n){const t=new Uint8Array(n);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function pl(n){const t="=".repeat((4-n.length%4)%4),o=(n+t).replace(/\-/g,"+").replace(/_/g,"/"),a=atob(o),c=new Uint8Array(a.length);for(let h=0;h<a.length;++h)c[h]=a.charCodeAt(h);return c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ml="firebase-messaging-database",bl=1,me="firebase-messaging-store";let At=null;function Gt(){return At||(At=nt(ml,bl,{upgrade:(n,t)=>{switch(t){case 0:n.createObjectStore(me)}}})),At}async function Wr(n){const t=Xt(n),a=await(await Gt()).transaction(me).objectStore(me).get(t);if(a)return a;{const c=await vl(n.appConfig.senderId);if(c)return await Jt(n,c),c}}async function Jt(n,t){const o=Xt(n),c=(await Gt()).transaction(me,"readwrite");return await c.objectStore(me).put(t,o),await c.done,t}async function _l(n){const t=Xt(n),a=(await Gt()).transaction(me,"readwrite");await a.objectStore(me).delete(t),await a.done}function Xt({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl=7*24*60*60*1e3;async function Cl(n){const t=await Al(n.swRegistration,n.vapidKey),o={vapidKey:n.vapidKey,swScope:n.swRegistration.scope,endpoint:t.endpoint,auth:ie(t.getKey("auth")),p256dh:ie(t.getKey("p256dh"))},a=await Wr(n.firebaseDependencies);if(a){if(Pl(a.subscriptionOptions,o))return Date.now()>=a.createTime+Tl?El(n,{token:a.token,createTime:Date.now(),subscriptionOptions:o}):a.token;try{await Kr(n.firebaseDependencies,a.token)}catch(c){console.warn(c)}return Qn(n.firebaseDependencies,o)}else return Qn(n.firebaseDependencies,o)}async function Il(n){const t=await Wr(n.firebaseDependencies);t&&(await Kr(n.firebaseDependencies,t.token),await _l(n.firebaseDependencies));const o=await n.swRegistration.pushManager.getSubscription();return o?o.unsubscribe():!0}async function El(n,t){try{const o=await kl(n.firebaseDependencies,t),a=Object.assign(Object.assign({},t),{token:o,createTime:Date.now()});return await Jt(n.firebaseDependencies,a),o}catch(o){throw await Il(n),o}}async function Qn(n,t){const a={token:await Sl(n,t),createTime:Date.now(),subscriptionOptions:t};return await Jt(n,a),a.token}async function Al(n,t){const o=await n.pushManager.getSubscription();return o||n.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:pl(t)})}function Pl(n,t){const o=t.vapidKey===n.vapidKey,a=t.endpoint===n.endpoint,c=t.auth===n.auth,h=t.p256dh===n.p256dh;return o&&a&&c&&h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rl(n){return typeof n=="object"&&!!n&&Vr in n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(n){if(!n||!n.options)throw Pt("App Configuration Object");if(!n.name)throw Pt("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:o}=n;for(const a of t)if(!o[a])throw Pt(a);return{appName:n.name,projectId:o.projectId,apiKey:o.apiKey,appId:o.appId,senderId:o.messagingSenderId}}function Pt(n){return $.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(t,o,a){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const c=Nl(t);this.firebaseDependencies={app:t,appConfig:c,installations:o,analyticsProvider:a}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jl(n){try{n.swRegistration=await navigator.serviceWorker.register(cl,{scope:ul}),n.swRegistration.update().catch(()=>{})}catch(t){throw $.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ml(n,t){if(!t&&!n.swRegistration&&await jl(n),!(!t&&!!n.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw $.create("invalid-sw-registration");n.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bl(n,t){t?n.vapidKey=t:n.vapidKey||(n.vapidKey=zr)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xr(n,t){if(!navigator)throw $.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw $.create("permission-blocked");return await Bl(n,t==null?void 0:t.vapidKey),await Ml(n,t==null?void 0:t.serviceWorkerRegistration),Cl(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fl(n,t,o){const a=Hl(t);(await n.firebaseDependencies.analyticsProvider.get()).logEvent(a,{message_id:o[Vr],message_name:o[hl],message_time:o[fl],message_device_time:Math.floor(Date.now()/1e3)})}function Hl(n){switch(n){case je.NOTIFICATION_CLICKED:return"notification_open";case je.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $l(n,t){const o=t.data;if(!o.isFirebaseMessaging)return;n.onMessageHandler&&o.messageType===je.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(Zn(o)):n.onMessageHandler.next(Zn(o)));const a=o.data;Rl(a)&&a[dl]==="1"&&await Fl(n,o.messageType,a)}const er="@firebase/messaging",tr="0.12.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ul=n=>{const t=new Ll(n.getProvider("app").getImmediate(),n.getProvider("installations-internal").getImmediate(),n.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",o=>$l(t,o)),t},ql=n=>{const t=n.getProvider("messaging").getImmediate();return{getToken:a=>Xr(t,a)}};function zl(){se(new Z("messaging",Ul,"PUBLIC")),se(new Z("messaging-internal",ql,"PRIVATE")),Q(er,tr),Q(er,tr,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vl(){try{await Ut()}catch{return!1}return typeof window<"u"&&$t()&&dr()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
