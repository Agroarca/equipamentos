import{d as Qe,r as Ht,o as de,c as lr,w as oa,k as Ae,l as sa,T as aa,a as Ie,j as ca,G as ua,x as hr,J as Rn,H as la,t as Nn,I as ha,F as fa,m as da,K as pa,L as ga,f as va,C as ya}from"./app-27f9bc00.js";import{r as Ze,t as Pe}from"./index-ac617c56.js";const ma={key:0,class:"loader"},ba=Ie("div",{class:"elemento"},null,-1),_a=[ba],Nh=Qe({__name:"Loader",setup(t){const n=Ht(!1);function o(){n.value=!0}function a(){n.value=!1}return window.loader={show:o,hide:a,active:n},(c,h)=>(de(),lr(aa,{name:"loader",duration:"300"},{default:oa(()=>[n.value?(de(),Ae("div",ma,_a)):sa("",!0)]),_:1}))}});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var x;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(x||(x={}));const za={debug:x.DEBUG,verbose:x.VERBOSE,info:x.INFO,warn:x.WARN,error:x.ERROR,silent:x.SILENT},Va=x.INFO,Wa={[x.DEBUG]:"log",[x.VERBOSE]:"log",[x.INFO]:"info",[x.WARN]:"warn",[x.ERROR]:"error"},Ka=(t,n,...o)=>{if(n<t.logLevel)return;const a=new Date().toISOString(),c=Wa[n];if(c)console[c](`[${a}]  ${t.name}:`,...o);else throw new Error(`Attempted to log a message with an invalid logType (value: ${n})`)};class vr{constructor(n){this.name=n,this._logLevel=Va,this._logHandler=Ka,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(n){if(!(n in x))throw new TypeError(`Invalid value "${n}" assigned to \`logLevel\``);this._logLevel=n}setLogLevel(n){this._logLevel=typeof n=="string"?za[n]:n}get logHandler(){return this._logHandler}set logHandler(n){if(typeof n!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=n}get userLogHandler(){return this._userLogHandler}set userLogHandler(n){this._userLogHandler=n}debug(...n){this._userLogHandler&&this._userLogHandler(this,x.DEBUG,...n),this._logHandler(this,x.DEBUG,...n)}log(...n){this._userLogHandler&&this._userLogHandler(this,x.VERBOSE,...n),this._logHandler(this,x.VERBOSE,...n)}info(...n){this._userLogHandler&&this._userLogHandler(this,x.INFO,...n),this._logHandler(this,x.INFO,...n)}warn(...n){this._userLogHandler&&this._userLogHandler(this,x.WARN,...n),this._logHandler(this,x.WARN,...n)}error(...n){this._userLogHandler&&this._userLogHandler(this,x.ERROR,...n),this._logHandler(this,x.ERROR,...n)}}const Ga=(t,n)=>n.some(o=>t instanceof o);let Mn,Bn;function Ja(){return Mn||(Mn=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Xa(){return Bn||(Bn=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const yr=new WeakMap,Ot=new WeakMap,mr=new WeakMap,bt=new WeakMap,qt=new WeakMap;function Ya(t){const n=new Promise((o,a)=>{const c=()=>{t.removeEventListener("success",h),t.removeEventListener("error",f)},h=()=>{o(ie(t.result)),c()},f=()=>{a(t.error),c()};t.addEventListener("success",h),t.addEventListener("error",f)});return n.then(o=>{o instanceof IDBCursor&&yr.set(o,t)}).catch(()=>{}),qt.set(n,t),n}function Qa(t){if(Ot.has(t))return;const n=new Promise((o,a)=>{const c=()=>{t.removeEventListener("complete",h),t.removeEventListener("error",f),t.removeEventListener("abort",f)},h=()=>{o(),c()},f=()=>{a(t.error||new DOMException("AbortError","AbortError")),c()};t.addEventListener("complete",h),t.addEventListener("error",f),t.addEventListener("abort",f)});Ot.set(t,n)}let xt={get(t,n,o){if(t instanceof IDBTransaction){if(n==="done")return Ot.get(t);if(n==="objectStoreNames")return t.objectStoreNames||mr.get(t);if(n==="store")return o.objectStoreNames[1]?void 0:o.objectStore(o.objectStoreNames[0])}return ie(t[n])},set(t,n,o){return t[n]=o,!0},has(t,n){return t instanceof IDBTransaction&&(n==="done"||n==="store")?!0:n in t}};function Za(t){xt=t(xt)}function ec(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(n,...o){const a=t.call(_t(this),n,...o);return mr.set(a,n.sort?n.sort():[n]),ie(a)}:Xa().includes(t)?function(...n){return t.apply(_t(this),n),ie(yr.get(this))}:function(...n){return ie(t.apply(_t(this),n))}}function tc(t){return typeof t=="function"?ec(t):(t instanceof IDBTransaction&&Qa(t),Ga(t,Ja())?new Proxy(t,xt):t)}function ie(t){if(t instanceof IDBRequest)return Ya(t);if(bt.has(t))return bt.get(t);const n=tc(t);return n!==t&&(bt.set(t,n),qt.set(n,t)),n}const _t=t=>qt.get(t);function tt(t,n,{blocked:o,upgrade:a,blocking:c,terminated:h}={}){const f=indexedDB.open(t,n),p=ie(f);return a&&f.addEventListener("upgradeneeded",g=>{a(ie(f.result),g.oldVersion,g.newVersion,ie(f.transaction))}),o&&f.addEventListener("blocked",()=>o()),p.then(g=>{h&&g.addEventListener("close",()=>h()),c&&g.addEventListener("versionchange",()=>c())}).catch(()=>{}),p}function wt(t,{blocked:n}={}){const o=indexedDB.deleteDatabase(t);return n&&o.addEventListener("blocked",()=>n()),ie(o).then(()=>{})}const nc=["get","getKey","getAll","getAllKeys","count"],rc=["put","add","delete","clear"],St=new Map;function Fn(t,n){if(!(t instanceof IDBDatabase&&!(n in t)&&typeof n=="string"))return;if(St.get(n))return St.get(n);const o=n.replace(/FromIndex$/,""),a=n!==o,c=rc.includes(o);if(!(o in(a?IDBIndex:IDBObjectStore).prototype)||!(c||nc.includes(o)))return;const h=async function(f,...p){const g=this.transaction(f,c?"readwrite":"readonly");let w=g.store;return a&&(w=w.index(p.shift())),(await Promise.all([w[o](...p),c&&g.done]))[0]};return St.set(n,h),h}Za(t=>({...t,get:(n,o,a)=>Fn(n,o)||t.get(n,o,a),has:(n,o)=>!!Fn(n,o)||t.has(n,o)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=1e4,Cr=`w:${zt}`,Ir="FIS_v2",Vc="https://firebaseinstallations.googleapis.com/v1",Wc=60*60*1e3,Kc="installations",Gc="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const au="firebase-installations-database",cu=1,ve="firebase-installations-store";let Tt=null;function Vt(){return Tt||(Tt=tt(au,cu,{upgrade:(t,n)=>{switch(n){case 0:t.createObjectStore(ve)}}})),Tt}async function ze(t,n){const o=nt(t),c=(await Vt()).transaction(ve,"readwrite"),h=c.objectStore(ve),f=await h.get(o);return await h.put(n,o),await c.done,(!f||f.fid!==n.fid)&&Lr(t,n.fid),n}async function Mr(t){const n=nt(t),a=(await Vt()).transaction(ve,"readwrite");await a.objectStore(ve).delete(n),await a.done}async function rt(t,n){const o=nt(t),c=(await Vt()).transaction(ve,"readwrite"),h=c.objectStore(ve),f=await h.get(o),p=n(f);return p===void 0?await h.delete(o):await h.put(p,o),await c.done,p&&(!f||f.fid!==p.fid)&&Lr(t,p.fid),p}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Su(t){const n=t,{installationEntry:o,registrationPromise:a}=await Wt(n);return a?a.catch(console.error):Kt(n).catch(console.error),o.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ku(t,n=!1){const o=t;return await Tu(o),(await Kt(o,n)).token}async function Tu(t){const{registrationPromise:n}=await Wt(t);n&&await n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cu(t){if(!t||!t.options)throw Ct("App Configuration");if(!t.name)throw Ct("App Name");const n=["projectId","apiKey","appId"];for(const o of n)if(!t.options[o])throw Ct(o);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function Ct(t){return ge.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="analytics",Ou="firebase_id",xu="origin",Du=60*1e3,Ru="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",$r="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class el{constructor(n){this.app=n}_delete(){return delete Ee[this.app.options.appId],Promise.resolve()}}let Ee={},Wn=[];const Kn={};let It="dataLayer",tl="gtag",Gn,Vr,Jn=!1;function nl(){const t=[];if(Da()&&t.push("This is a browser extension environment."),gr()||t.push("Cookies are not available."),t.length>0){const n=t.map((a,c)=>`(${c+1}) ${a}`).join(" "),o=V.create("invalid-analytics-context",{errorInfo:n});U.warn(o.message)}}function rl(t,n,o){nl();const a=t.options.appId;if(!a)throw V.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)U.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw V.create("no-api-key");if(Ee[a]!=null)throw V.create("already-exists",{id:a});if(!Jn){Lu(It);const{wrappedGtag:h,gtagCore:f}=Fu(Ee,Wn,Kn,It,tl);Vr=h,Gn=f,Jn=!0}return Ee[a]=Zu(t,Wn,Kn,n,Gn,It,o),new el(t)}function il(t=_r()){t=et(t);const n=Re(t,Ve);return n.isInitialized()?n.getImmediate():ol(t)}function ol(t,n={}){const o=Re(t,Ve);if(o.isInitialized()){const c=o.getImmediate();if(Ue(n,o.getOptions()))return c;throw V.create("already-initialized")}return o.initialize({options:n})}function sl(t,n,o,a){t=et(t),Yu(Vr,Ee[t.app.options.appId],n,o,a).catch(c=>U.error(c))}const Xn="@firebase/analytics",Yn="0.9.4";function al(){oe(new Q(Ve,(n,{options:o})=>{const a=n.getProvider("app").getImmediate(),c=n.getProvider("installations-internal").getImmediate();return rl(a,c,o)},"PUBLIC")),oe(new Q("analytics-internal",t,"PRIVATE")),Y(Xn,Yn),Y(Xn,Yn,"esm2017");function t(n){try{const o=n.getProvider(Ve).getImmediate();return{logEvent:(a,c,h)=>sl(o,a,c,h)}}catch(o){throw V.create("interop-component-reg-failed",{reason:o})}}}al();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl="/firebase-messaging-sw.js",ul="/firebase-cloud-messaging-push-scope",Wr="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",ll="https://fcmregistrations.googleapis.com/v1",Kr="google.c.a.c_id",hl="google.c.a.c_l",fl="google.c.a.ts",dl="google.c.a.e";var Qn;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Qn||(Qn={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(t){if(!t||!t.options)throw Pt("App Configuration Object");if(!t.name)throw Pt("App Name");const n=["projectId","apiKey","appId","messagingSenderId"],{options:o}=t;for(const a of n)if(!o[a])throw Pt(a);return{appName:t.name,projectId:o.projectId,apiKey:o.apiKey,appId:o.appId,senderId:o.messagingSenderId}}function Pt(t){return H.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bl(t,n){n?t.vapidKey=n:t.vapidKey||(t.vapidKey=Wr)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vl(){try{await Ut()}catch{return!1}return typeof window<"u"&&$t()&&gr()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
