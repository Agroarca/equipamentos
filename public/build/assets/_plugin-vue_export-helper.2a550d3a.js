 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uc="firebase-heartbeat-database",qc=1,Le="firebase-heartbeat-store";let mt=null;function pr(){return mt||(mt=Ye(Uc,qc,{upgrade:(r,t)=>{switch(t){case 0:r.createObjectStore(Le)}}}).catch(r=>{throw ce.create("idb-open",{originalErrorMessage:r.message})})),mt}async function zc(r){try{return(await pr()).transaction(Le).objectStore(Le).get(gr(r))}catch(t){if(t instanceof _e)ve.warn(t.message);else{const o=ce.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});ve.warn(o.message)}}}async function Mn(r,t){try{const c=(await pr()).transaction(Le,"readwrite");return await c.objectStore(Le).put(t,gr(r)),c.done}catch(o){if(o instanceof _e)ve.warn(o.message);else{const c=ce.create("idb-set",{originalErrorMessage:o==null?void 0:o.message});ve.warn(c.message)}}}function gr(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(Yc,Qc,"app");const vr="@firebase/installations",$t="0.6.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yr=1e4,mr=`w:${$t}`,br="FIS_v2",Zc="https://firebaseinstallations.googleapis.com/v1",eu=60*60*1e3,tu="installations",nu="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wr({projectId:r}){return`${Zc}/projects/${r}/installations`}function Sr(r){return{token:r.token,requestStatus:2,expiresIn:ou(r.expiresIn),creationTime:Date.now()}}async function kr(r,t){const c=(await t.json()).error;return ye.create("request-failed",{requestName:r,serverCode:c.code,serverMessage:c.message,serverStatus:c.status})}function Tr({apiKey:r}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":r})}function iu(r,{refreshToken:t}){const o=Tr(r);return o.append("Authorization",su(t)),o}async function Cr(r){const t=await r();return t.status>=500&&t.status<600?r():t}function ou(r){return Number(r.replace("s","000"))}function su(r){return`${br} ${r}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function au({appConfig:r,heartbeatServiceProvider:t},{fid:o}){const c=wr(r),a=Tr(r),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&a.append("x-firebase-client",w)}const f={fid:o,authVersion:br,appId:r.appId,sdkVersion:mr},g={method:"POST",headers:a,body:JSON.stringify(f)},p=await Cr(()=>fetch(c,g));if(p.ok){const w=await p.json();return{fid:w.fid||o,registrationStatus:2,refreshToken:w.refreshToken,authToken:Sr(w.authToken)}}else throw await kr("Create Installation",p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(r){return new Promise(t=>{setTimeout(t,r)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Er=new Map;function Ar(r,t){const o=Qe(r);Pr(o,t),fu(o,t)}function Pr(r,t){const o=Er.get(r);if(!!o)for(const c of o)c(t)}function fu(r,t){const o=du();o&&o.postMessage({key:r,fid:t}),pu()}let pe=null;function du(){return!pe&&"BroadcastChannel"in self&&(pe=new BroadcastChannel("[Firebase] FID Change"),pe.onmessage=r=>{Pr(r.data.key,r.data.fid)}),pe}function pu(){Er.size===0&&pe&&(pe.close(),pe=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qt(r){let t;const o=await Ze(r.appConfig,c=>{const a=yu(c),h=mu(r,a);return t=h.registrationPromise,h.installationEntry});return o.fid===Rt?{installationEntry:await t}:{installationEntry:o,registrationPromise:t}}function yu(r){const t=r||{fid:lu(),registrationStatus:0};return xr(t)}function mu(r,t){if(t.registrationStatus===0){if(!navigator.onLine){const a=Promise.reject(ye.create("app-offline"));return{installationEntry:t,registrationPromise:a}}const o={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},c=bu(r,o);return{installationEntry:o,registrationPromise:c}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:_u(r)}:{installationEntry:t}}async function bu(r,t){try{const o=await au(r,t);return Ge(r.appConfig,o)}catch(o){throw _r(o)&&o.customData.serverCode===409?await Or(r.appConfig):await Ge(r.appConfig,{fid:t.fid,registrationStatus:0}),o}}async function _u(r){let t=await Hn(r.appConfig);for(;t.registrationStatus===1;)await Ir(100),t=await Hn(r.appConfig);if(t.registrationStatus===0){const{installationEntry:o,registrationPromise:c}=await qt(r);return c||o}return t}function Hn(r){return Ze(r,t=>{if(!t)throw ye.create("installation-not-found");return xr(t)})}function xr(r){return wu(r)?{fid:r.fid,registrationStatus:0}:r}function wu(r){return r.registrationStatus===1&&r.registrationTime+yr<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Su({appConfig:r,heartbeatServiceProvider:t},o){const c=ku(r,o),a=iu(r,o),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&a.append("x-firebase-client",w)}const f={installation:{sdkVersion:mr,appId:r.appId}},g={method:"POST",headers:a,body:JSON.stringify(f)},p=await Cr(()=>fetch(c,g));if(p.ok){const w=await p.json();return Sr(w)}else throw await kr("Generate Auth Token",p)}function ku(r,{fid:t}){return`${wr(r)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(r,t=!1){let o;const c=await Ze(r.appConfig,h=>{if(!Dr(h))throw ye.create("not-registered");const f=h.authToken;if(!t&&Iu(f))return h;if(f.requestStatus===1)return o=Tu(r,t),h;{if(!navigator.onLine)throw ye.create("app-offline");const g=Au(h);return o=Cu(r,g),g}});return o?await o:c.authToken}async function Tu(r,t){let o=await $n(r.appConfig);for(;o.authToken.requestStatus===1;)await Ir(100),o=await $n(r.appConfig);const c=o.authToken;return c.requestStatus===0?zt(r,t):c}function $n(r){return Ze(r,t=>{if(!Dr(t))throw ye.create("not-registered");const o=t.authToken;return Pu(o)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function Cu(r,t){try{const o=await Su(r,t),c=Object.assign(Object.assign({},t),{authToken:o});return await Ge(r.appConfig,c),o}catch(o){if(_r(o)&&(o.customData.serverCode===401||o.customData.serverCode===404))await Or(r.appConfig);else{const c=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await Ge(r.appConfig,c)}throw o}}function Dr(r){return r!==void 0&&r.registrationStatus===2}function Iu(r){return r.requestStatus===2&&!Eu(r)}function Eu(r){const t=Date.now();return t<r.creationTime||r.creationTime+r.expiresIn<t+eu}function Au(r){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},r),{authToken:t})}function Pu(r){return r.requestStatus===1&&r.requestTime+yr<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr="installations",Lu="installations-internal",Nu=r=>{const t=r.getProvider("app").getImmediate(),o=Ru(t),c=Be(t,"heartbeat");return{app:t,appConfig:o,heartbeatServiceProvider:c,_delete:()=>Promise.resolve()}},ju=r=>{const t=r.getProvider("app").getImmediate(),o=Be(t,Rr).getImmediate();return{getId:()=>Ou(o),getToken:a=>xu(o,a)}};function Mu(){se(new Z(Rr,Nu,"PUBLIC")),se(new Z(Lu,ju,"PRIVATE"))}Mu();Q(vr,$t);Q(vr,$t,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="analytics",Bu="firebase_id",Fu="origin",Hu=60*1e3,$u="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Lr="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const q=new ur("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(r){return Promise.all(r.map(t=>t.catch(o=>o)))}function Uu(r,t){const o=document.createElement("script");o.src=`${Lr}?l=${r}&id=${t}`,o.async=!0,document.head.appendChild(o)}function qu(r){let t=[];return Array.isArray(window[r])?t=window[r]:window[r]=t,t}async function zu(r,t,o,c,a,h){const f=c[a];try{if(f)await t[f];else{const p=(await Nr(o)).find(w=>w.measurementId===a);p&&await t[p.appId]}}catch(g){q.error(g)}r("config",a,h)}async function Vu(r,t,o,c,a){try{let h=[];if(a&&a.send_to){let f=a.send_to;Array.isArray(f)||(f=[f]);const g=await Nr(o);for(const p of f){const w=g.find(E=>E.measurementId===p),_=w&&t[w.appId];if(_)h.push(_);else{h=[];break}}}h.length===0&&(h=Object.values(t)),await Promise.all(h),r("event",c,a||{})}catch(h){q.error(h)}}function Wu(r,t,o,c){async function a(h,f,g){try{h==="event"?await Vu(r,t,o,f,g):h==="config"?await zu(r,t,o,c,f,g):h==="consent"?r("consent","update",g):r("set",f)}catch(p){q.error(p)}}return a}function Ku(r,t,o,c,a){let h=function(...f){window[c].push(arguments)};return window[a]&&typeof window[a]=="function"&&(h=window[a]),window[a]=Wu(h,r,t,o),{gtagCore:h,wrappedGtag:window[a]}}function Gu(r){const t=window.document.getElementsByTagName("script");for(const o of Object.values(t))if(o.src&&o.src.includes(Lr)&&o.src.includes(r))return o;return null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vl="/firebase-messaging-sw.js",yl="/firebase-cloud-messaging-push-scope",Fr="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",ml="https://fcmregistrations.googleapis.com/v1",Hr="google.c.a.c_id",bl="google.c.a.c_l",_l="google.c.a.ts",wl="google.c.a.e";var Gn;(function(r){r[r.DATA_MESSAGE=1]="DATA_MESSAGE",r[r.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Gn||(Gn={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ol(r,t){const o=await Jt(r),c=qr(t),a={method:"POST",headers:o,body:JSON.stringify(c)};let h;try{h=await(await fetch(Gt(r.appConfig),a)).json()}catch(f){throw H.create("token-subscribe-failed",{errorInfo:f==null?void 0:f.toString()})}if(h.error){const f=h.error.message;throw H.create("token-subscribe-failed",{errorInfo:f})}if(!h.token)throw H.create("token-subscribe-no-token");return h.token}async function xl(r,t){const o=await Jt(r),c=qr(t.subscriptionOptions),a={method:"PATCH",headers:o,body:JSON.stringify(c)};let h;try{h=await(await fetch(`${Gt(r.appConfig)}/${t.token}`,a)).json()}catch(f){throw H.create("token-update-failed",{errorInfo:f==null?void 0:f.toString()})}if(h.error){const f=h.error.message;throw H.create("token-update-failed",{errorInfo:f})}if(!h.token)throw H.create("token-update-no-token");return h.token}async function Ur(r,t){const c={method:"DELETE",headers:await Jt(r)};try{const h=await(await fetch(`${Gt(r.appConfig)}/${t}`,c)).json();if(h.error){const f=h.error.message;throw H.create("token-unsubscribe-failed",{errorInfo:f})}}catch(a){throw H.create("token-unsubscribe-failed",{errorInfo:a==null?void 0:a.toString()})}}function Gt({projectId:r}){return`${ml}/projects/${r}/registrations`}async function Jt({appConfig:r,installations:t}){const o=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":r.apiKey,"x-goog-firebase-installations-auth":`FIS ${o}`})}function qr({p256dh:r,auth:t,endpoint:o,vapidKey:c}){const a={web:{endpoint:o,auth:t,p256dh:r}};return c!==Fr&&(a.web.applicationPubKey=c),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(r){return typeof r=="object"&&!!r&&Hr in r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zr("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o");zr("AzSCbw63g1R0nCw85jG8","Iaya3yLKwmgvh7cF0q4");function zr(r,t){const o=[];for(let c=0;c<r.length;c++)o.push(r.charAt(c)),c<t.length&&o.push(t.charAt(c));return o.join("")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wl(r,t){t?r.vapidKey=t:r.vapidKey||(r.vapidKey=Fr)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vr(r,t){if(!navigator)throw H.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw H.create("permission-blocked");return await Wl(r,t==null?void 0:t.vapidKey),await Vl(r,t==null?void 0:t.serviceWorkerRegistration),Rl(r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kl(r,t,o){const c=Gl(t);(await r.firebaseDependencies.analyticsProvider.get()).logEvent(c,{message_id:o[Hr],message_name:o[bl],message_time:o[_l],message_device_time:Math.floor(Date.now()/1e3)})}function Gl(r){switch(r){case Ne.NOTIFICATION_CLICKED:return"notification_open";case Ne.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xl=r=>{const t=new ql(r.getProvider("app").getImmediate(),r.getProvider("installations-internal").getImmediate(),r.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",o=>Jl(t,o)),t},Yl=r=>{const t=r.getProvider("messaging").getImmediate();return{getToken:c=>Vr(t,c)}};function Ql(){se(new Z("messaging",Xl,"PUBLIC")),se(new Z("messaging-internal",Yl,"PRIVATE")),Q(Qn,Zn),Q(Qn,Zn,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zl(){try{await Ft()}catch{return!1}return typeof window<"u"&&Bt()&&cr()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function th(r=dr()){return Zl().then(t=>{if(!t)throw H.create("unsupported-browser")},t=>{throw H.create("indexed-db-unsupported")}),Be(Me(r),"messaging").getImmediate()}async function nh(r,t){return r=Me(r),Vr(r,t)}function rh(r,t){return r=Me(r),eh(r,t)}Ql();const ih={apiKey:"AIzaSyDK6yPqneJ5TafOA_AySHcCw0wps_F8CPE",authDomain:"agroarca-equipamentos.firebaseapp.com",projectId:"agroarca-equipamentos",messagingSenderId:"260002359203",appId:"1:260002359203:web:8c19a187bf2fe28079dc16",measurementId:"G-DHSLGFC76R"},oh="BPlE43kDpMP4nb3ltOOZZRDDxkJA-CKsdim6elA8c5amJmykNZl-_UmxsRGJGe1P3I0R50Qgwyf7Tlaf9ICUcqU";let ae;class sh{constructor(){R(this,"app");R(this,"messaging");R(this,"analytics");this.app=fr(ih),this.messaging=th(this.app),this.analytics=fl(this.app)}solicitarPermissao(){return new Promise((t,o)=>{if(Notification.permission==="denied"){o();return}if(Notification.permission==="granted"){t();return}Notification.requestPermission().then(c=>{if(Notification.permission==="granted"){t();return}o()})})}iniciarNotificacoes(){Nt(()=>{this.solicitarPermissao().then(this.registrarListeners)})}registrarListeners(){nh(ae.messaging,{vapidKey:oh}).then(t=>{t&&ae.salvarToken(t)}),rh(ae.messaging,ae.onMessage)}salvarToken(t){ta.post(route("site.notificacao.salvarToken"),{token:t})}onMessage(t){this.notificar(` onMessage ${JSON.stringify(t)}`)}notificar(t){new Notification(t)}}function ah(){return ae||(ae=new sh,ae)}function ch(){Ea(),ah().iniciarNotificacoes()}const uh={class:"toast-header"},lh={class:"me-auto"},hh=Pe("button",{type:"button",class:"btn-close","data-bs-dismiss":"toast","aria-label":"Close"},null,-1),fh={class:"toast-body"},dh={__name:"Notificacao",props:["id","titulo","texto"],setup(r){const t=r,o=Lt(null);let c;Nt(()=>{c=new na(o.value),c.show({autohide:!1})});function a(){ra.visit(route("site.notificacao",[t.id]))}return(h,f)=>(ge(),Re("div",{ref_key:"toast",ref:o,class:"toast notificacao",role:"alert",onClick:a},[Pe("div",uh,[Pe("span",lh,En(r.titulo),1),hh]),Pe("div",fh,En(r.texto),1)],512))}};class ph{constructor(t,o=10){R(this,"priority");R(this,"callback");this.priority=o,this.callback=t}}const gh={class:"toast-container position-fixed top-0 end-0 p-3"},vh=ia({__name:"Notificacoes",setup(r){ch();const t=Lt([]);ke.addListener(new ph(o));function o(c){t.value.push(c.notificacao),setTimeout(()=>{const a=t.value.indexOf(c.notificacao);t.value.splice(a,1)},1e5)}return(c,a)=>(ge(),Re("div",gh,[(ge(!0),Re(oa,null,sa(t.value,h=>(ge(),er(dh,aa(ca({key:h.id},h)),null,16))),128))]))}}),yh={class:"base-layout"},wh={__name:"BaseLayout",setup(r){return(t,o)=>(ge(),Re("div",yh,[ua(vh),la(t.$slots,"default")]))}},Sh=(r,t)=>{const o=r.__vccOpts||r;for(const[c,a]of t)o[c]=a;return o};export{Ae as E,ph as L,Sh as _,_h as a,wh as b};
