 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xa=()=>Oa().__FIREBASE_DEFAULTS__,Da=()=>{if(typeof process>"u"||typeof process.env>"u")return;const r={}.__FIREBASE_DEFAULTS__;if(r)return JSON.parse(r)},Ra=()=>{if(typeof document>"u")return;let r;try{r=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=r&&Pa(r[1]);return t&&JSON.parse(t)},La=()=>{try{return xa()||Da()||Ra()}catch(r){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${r}`);return}},Na=()=>{var r;return(r=La())===null||r===void 0?void 0:r.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ba="FirebaseError";class _e extends Error{constructor(t,o,a){super(o),this.code=t,this.customData=a,this.name=Ba,Object.setPrototypeOf(this,_e.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,je.prototype.create)}}class je{constructor(t,o,a){this.service=t,this.serviceName=o,this.errors=a}create(t,...o){const a=o[0]||{},c=`${this.service}/${t}`,h=this.errors[t],f=h?Fa(h,a):"Error",g=`${this.serviceName}: ${f} (${c}).`;return new _e(c,g,a)}}function Fa(r,t){return r.replace(Ha,(o,a)=>{const c=t[a];return c!=null?String(c):`<${a}?>`})}const Ha=/\{\$([^}]+)}/g;function We(r,t){if(r===t)return!0;const o=Object.keys(r),a=Object.keys(t);for(const c of o){if(!a.includes(c))return!1;const h=r[c],f=t[c];if(xn(h)&&xn(f)){if(!We(h,f))return!1}else if(h!==f)return!1}for(const c of a)if(!o.includes(c))return!1;return!0}function xn(r){return r!==null&&typeof r=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $a=1e3,Ua=2,qa=4*60*60*1e3,za=.5;function Dn(r,t=$a,o=Ua){const a=t*Math.pow(o,r),c=Math.round(za*a*(Math.random()-.5)*2);return Math.min(qa,a+c)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Va{constructor(t,o){this.name=t,this.container=o,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const o=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(o)){const a=new ja;if(this.instancesDeferred.set(o,a),this.isInitialized(o)||this.shouldAutoInitialize())try{const c=this.getOrInitializeService({instanceIdentifier:o});c&&a.resolve(c)}catch{}}return this.instancesDeferred.get(o).promise}getImmediate(t){var o;const a=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),c=(o=t==null?void 0:t.optional)!==null&&o!==void 0?o:!1;if(this.isInitialized(a)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:a})}catch(h){if(c)return null;throw h}else{if(c)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Ka(t))try{this.getOrInitializeService({instanceIdentifier:de})}catch{}for(const[o,a]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(o);try{const h=this.getOrInitializeService({instanceIdentifier:c});a.resolve(h)}catch{}}}}clearInstance(t=de){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(o=>"INTERNAL"in o).map(o=>o.INTERNAL.delete()),...t.filter(o=>"_delete"in o).map(o=>o._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=de){return this.instances.has(t)}getOptions(t=de){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:o={}}=t,a=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(a))throw Error(`${this.name}(${a}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const c=this.getOrInitializeService({instanceIdentifier:a,options:o});for(const[h,f]of this.instancesDeferred.entries()){const g=this.normalizeInstanceIdentifier(h);a===g&&f.resolve(c)}return c}onInit(t,o){var a;const c=this.normalizeInstanceIdentifier(o),h=(a=this.onInitCallbacks.get(c))!==null&&a!==void 0?a:new Set;h.add(t),this.onInitCallbacks.set(c,h);const f=this.instances.get(c);return f&&t(f,c),()=>{h.delete(t)}}invokeOnInitCallbacks(t,o){const a=this.onInitCallbacks.get(o);if(!!a)for(const c of a)try{c(t,o)}catch{}}getOrInitializeService({instanceIdentifier:t,options:o={}}){let a=this.instances.get(t);if(!a&&this.component&&(a=this.component.instanceFactory(this.container,{instanceIdentifier:Wa(t),options:o}),this.instances.set(t,a),this.instancesOptions.set(t,o),this.invokeOnInitCallbacks(a,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,a)}catch{}return a||null}normalizeInstanceIdentifier(t=de){return this.component?this.component.multipleInstances?t:de:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Wa(r){return r===de?void 0:r}function Ka(r){return r.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ga{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const o=this.getProvider(t.name);if(o.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);o.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const o=new Va(t,this);return this.providers.set(t,o),o}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var D;(function(r){r[r.DEBUG=0]="DEBUG",r[r.VERBOSE=1]="VERBOSE",r[r.INFO=2]="INFO",r[r.WARN=3]="WARN",r[r.ERROR=4]="ERROR",r[r.SILENT=5]="SILENT"})(D||(D={}));const Ja={debug:D.DEBUG,verbose:D.VERBOSE,info:D.INFO,warn:D.WARN,error:D.ERROR,silent:D.SILENT},Xa=D.INFO,Ya={[D.DEBUG]:"log",[D.VERBOSE]:"log",[D.INFO]:"info",[D.WARN]:"warn",[D.ERROR]:"error"},Qa=(r,t,...o)=>{if(t<r.logLevel)return;const a=new Date().toISOString(),c=Ya[t];if(c)console[c](`[${a}]  ${r.name}:`,...o);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class fr{constructor(t){this.name=t,this._logLevel=Xa,this._logHandler=Qa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in D))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?Ja[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,D.DEBUG,...t),this._logHandler(this,D.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,D.VERBOSE,...t),this._logHandler(this,D.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,D.INFO,...t),this._logHandler(this,D.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,D.WARN,...t),this._logHandler(this,D.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,D.ERROR,...t),this._logHandler(this,D.ERROR,...t)}}const Za=(r,t)=>t.some(o=>r instanceof o);let Rn,Ln;function ec(){return Rn||(Rn=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function tc(){return Ln||(Ln=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const dr=new WeakMap,At=new WeakMap,pr=new WeakMap,pt=new WeakMap,Ht=new WeakMap;function nc(r){const t=new Promise((o,a)=>{const c=()=>{r.removeEventListener("success",h),r.removeEventListener("error",f)},h=()=>{o(oe(r.result)),c()},f=()=>{a(r.error),c()};r.addEventListener("success",h),r.addEventListener("error",f)});return t.then(o=>{o instanceof IDBCursor&&dr.set(o,r)}).catch(()=>{}),Ht.set(t,r),t}function rc(r){if(At.has(r))return;const t=new Promise((o,a)=>{const c=()=>{r.removeEventListener("complete",h),r.removeEventListener("error",f),r.removeEventListener("abort",f)},h=()=>{o(),c()},f=()=>{a(r.error||new DOMException("AbortError","AbortError")),c()};r.addEventListener("complete",h),r.addEventListener("error",f),r.addEventListener("abort",f)});At.set(r,t)}let Pt={get(r,t,o){if(r instanceof IDBTransaction){if(t==="done")return At.get(r);if(t==="objectStoreNames")return r.objectStoreNames||pr.get(r);if(t==="store")return o.objectStoreNames[1]?void 0:o.objectStore(o.objectStoreNames[0])}return oe(r[t])},set(r,t,o){return r[t]=o,!0},has(r,t){return r instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in r}};function ic(r){Pt=r(Pt)}function oc(r){return r===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...o){const a=r.call(gt(this),t,...o);return pr.set(a,t.sort?t.sort():[t]),oe(a)}:tc().includes(r)?function(...t){return r.apply(gt(this),t),oe(dr.get(this))}:function(...t){return oe(r.apply(gt(this),t))}}function sc(r){return typeof r=="function"?oc(r):(r instanceof IDBTransaction&&rc(r),Za(r,ec())?new Proxy(r,Pt):r)}function oe(r){if(r instanceof IDBRequest)return nc(r);if(pt.has(r))return pt.get(r);const t=sc(r);return t!==r&&(pt.set(r,t),Ht.set(t,r)),t}const gt=r=>Ht.get(r);function Ye(r,t,{blocked:o,upgrade:a,blocking:c,terminated:h}={}){const f=indexedDB.open(r,t),g=oe(f);return a&&f.addEventListener("upgradeneeded",p=>{a(oe(f.result),p.oldVersion,p.newVersion,oe(f.transaction))}),o&&f.addEventListener("blocked",()=>o()),g.then(p=>{h&&p.addEventListener("close",()=>h()),c&&p.addEventListener("versionchange",()=>c())}).catch(()=>{}),g}function vt(r,{blocked:t}={}){const o=indexedDB.deleteDatabase(r);return t&&o.addEventListener("blocked",()=>t()),oe(o).then(()=>{})}const ac=["get","getKey","getAll","getAllKeys","count"],cc=["put","add","delete","clear"],yt=new Map;function Nn(r,t){if(!(r instanceof IDBDatabase&&!(t in r)&&typeof t=="string"))return;if(yt.get(t))return yt.get(t);const o=t.replace(/FromIndex$/,""),a=t!==o,c=cc.includes(o);if(!(o in(a?IDBIndex:IDBObjectStore).prototype)||!(c||ac.includes(o)))return;const h=async function(f,...g){const p=this.transaction(f,c?"readwrite":"readonly");let w=p.store;return a&&(w=w.index(g.shift())),(await Promise.all([w[o](...g),c&&p.done]))[0]};return yt.set(t,h),h}ic(r=>({...r,get:(t,o,a)=>Nn(t,o)||r.get(t,o,a),has:(t,o)=>!!Nn(t,o)||r.has(t,o)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uc{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(o=>{if(lc(o)){const a=o.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(o=>o).join(" ")}}function lc(r){const t=r.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Ot="@firebase/app",jn="0.9.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ve=new fr("@firebase/app"),hc="@firebase/app-compat",fc="@firebase/analytics-compat",dc="@firebase/analytics",pc="@firebase/app-check-compat",gc="@firebase/app-check",vc="@firebase/auth",yc="@firebase/auth-compat",mc="@firebase/database",bc="@firebase/database-compat",_c="@firebase/functions",wc="@firebase/functions-compat",Sc="@firebase/installations",kc="@firebase/installations-compat",Tc="@firebase/messaging",Cc="@firebase/messaging-compat",Ic="@firebase/performance",Ec="@firebase/performance-compat",Ac="@firebase/remote-config",Pc="@firebase/remote-config-compat",Oc="@firebase/storage",xc="@firebase/storage-compat",Dc="@firebase/firestore",Rc="@firebase/firestore-compat",Lc="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt="[DEFAULT]",Nc={[Ot]:"fire-core",[hc]:"fire-core-compat",[dc]:"fire-analytics",[fc]:"fire-analytics-compat",[gc]:"fire-app-check",[pc]:"fire-app-check-compat",[vc]:"fire-auth",[yc]:"fire-auth-compat",[mc]:"fire-rtdb",[bc]:"fire-rtdb-compat",[_c]:"fire-fn",[wc]:"fire-fn-compat",[Sc]:"fire-iid",[kc]:"fire-iid-compat",[Tc]:"fire-fcm",[Cc]:"fire-fcm-compat",[Ic]:"fire-perf",[Ec]:"fire-perf-compat",[Ac]:"fire-rc",[Pc]:"fire-rc-compat",[Oc]:"fire-gcs",[xc]:"fire-gcs-compat",[Dc]:"fire-fst",[Rc]:"fire-fst-compat","fire-js":"fire-js",[Lc]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uc=1024,qc=30*24*60*60*1e3;class zc{constructor(t){this.container=t,this._heartbeatsCache=null;const o=this.container.getProvider("app").getImmediate();this._storage=new Wc(o),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),a=Bn();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===a||this._heartbeatsCache.heartbeats.some(c=>c.date===a)))return this._heartbeatsCache.heartbeats.push({date:a,agent:o}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(c=>{const h=new Date(c.date).valueOf();return Date.now()-h<=qc}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Bn(),{heartbeatsToSend:o,unsentEntries:a}=Vc(this._heartbeatsCache.heartbeats),c=lr(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),c}}function Bn(){return new Date().toISOString().substring(0,10)}function Vc(r,t=Uc){const o=[];let a=r.slice();for(const c of r){const h=o.find(f=>f.agent===c.agent);if(h){if(h.dates.push(c.date),Fn(o)>t){h.dates.pop();break}}else if(o.push({agent:c.agent,dates:[c.date]}),Fn(o)>t){o.pop();break}a=a.slice(1)}return{heartbeatsToSend:o,unsentEntries:a}}class Wc{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Bt()?Ft().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await $c(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(t){var o;if(await this._canUseIndexedDBPromise){const c=await this.read();return Mn(this.app,{lastSentHeartbeatDate:(o=t.lastSentHeartbeatDate)!==null&&o!==void 0?o:c.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var o;if(await this._canUseIndexedDBPromise){const c=await this.read();return Mn(this.app,{lastSentHeartbeatDate:(o=t.lastSentHeartbeatDate)!==null&&o!==void 0?o:c.lastSentHeartbeatDate,heartbeats:[...c.heartbeats,...t.heartbeats]})}else return}}function Fn(r){return lr(JSON.stringify({version:2,heartbeats:r})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kc(r){se(new Z("platform-logger",t=>new uc(t),"PRIVATE")),se(new Z("heartbeat",t=>new zc(t),"PRIVATE")),Q(Ot,jn,r),Q(Ot,jn,"esm2017"),Q("fire-js","")}Kc("");var Gc="firebase",Jc="9.16.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(Gc,Jc,"app");const br="@firebase/installations",$t="0.6.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r=1e4,wr=`w:${$t}`,Sr="FIS_v2",Xc="https://firebaseinstallations.googleapis.com/v1",Yc=60*60*1e3,Qc="installations",Zc="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tr({projectId:r}){return`${Xc}/projects/${r}/installations`}function Cr(r){return{token:r.token,requestStatus:2,expiresIn:nu(r.expiresIn),creationTime:Date.now()}}async function Ir(r,t){const a=(await t.json()).error;return ye.create("request-failed",{requestName:r,serverCode:a.code,serverMessage:a.message,serverStatus:a.status})}function Er({apiKey:r}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":r})}function tu(r,{refreshToken:t}){const o=Er(r);return o.append("Authorization",ru(t)),o}async function Ar(r){const t=await r();return t.status>=500&&t.status<600?r():t}function nu(r){return Number(r.replace("s","000"))}function ru(r){return`${Sr} ${r}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function iu({appConfig:r,heartbeatServiceProvider:t},{fid:o}){const a=Tr(r),c=Er(r),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&c.append("x-firebase-client",w)}const f={fid:o,authVersion:Sr,appId:r.appId,sdkVersion:wr},g={method:"POST",headers:c,body:JSON.stringify(f)},p=await Ar(()=>fetch(a,g));if(p.ok){const w=await p.json();return{fid:w.fid||o,registrationStatus:2,refreshToken:w.refreshToken,authToken:Cr(w.authToken)}}else throw await Ir("Create Installation",p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ou(r){return btoa(String.fromCharCode(...r)).replace(/\+/g,"-").replace(/\//g,"_")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const su=/^[cdef][\w-]{21}$/,Rt="";function au(){try{const r=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(r),r[0]=112+r[0]%16;const o=cu(r);return su.test(o)?o:Rt}catch{return Rt}}function cu(r){return ou(r).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Or=new Map;function xr(r,t){const o=Qe(r);Dr(o,t),uu(o,t)}function Dr(r,t){const o=Or.get(r);if(!!o)for(const a of o)a(t)}function uu(r,t){const o=lu();o&&o.postMessage({key:r,fid:t}),hu()}let pe=null;function lu(){return!pe&&"BroadcastChannel"in self&&(pe=new BroadcastChannel("[Firebase] FID Change"),pe.onmessage=r=>{Dr(r.data.key,r.data.fid)}),pe}function hu(){Or.size===0&&pe&&(pe.close(),pe=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qt(r){let t;const o=await Ze(r.appConfig,a=>{const c=pu(a),h=gu(r,c);return t=h.registrationPromise,h.installationEntry});return o.fid===Rt?{installationEntry:await t}:{installationEntry:o,registrationPromise:t}}function pu(r){const t=r||{fid:au(),registrationStatus:0};return Lr(t)}function gu(r,t){if(t.registrationStatus===0){if(!navigator.onLine){const c=Promise.reject(ye.create("app-offline"));return{installationEntry:t,registrationPromise:c}}const o={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},a=vu(r,o);return{installationEntry:o,registrationPromise:a}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:yu(r)}:{installationEntry:t}}async function vu(r,t){try{const o=await iu(r,t);return Ge(r.appConfig,o)}catch(o){throw kr(o)&&o.customData.serverCode===409?await Rr(r.appConfig):await Ge(r.appConfig,{fid:t.fid,registrationStatus:0}),o}}async function yu(r){let t=await Hn(r.appConfig);for(;t.registrationStatus===1;)await Pr(100),t=await Hn(r.appConfig);if(t.registrationStatus===0){const{installationEntry:o,registrationPromise:a}=await qt(r);return a||o}return t}function Hn(r){return Ze(r,t=>{if(!t)throw ye.create("installation-not-found");return Lr(t)})}function Lr(r){return mu(r)?{fid:r.fid,registrationStatus:0}:r}function mu(r){return r.registrationStatus===1&&r.registrationTime+_r<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bu({appConfig:r,heartbeatServiceProvider:t},o){const a=_u(r,o),c=tu(r,o),h=t.getImmediate({optional:!0});if(h){const w=await h.getHeartbeatsHeader();w&&c.append("x-firebase-client",w)}const f={installation:{sdkVersion:wr,appId:r.appId}},g={method:"POST",headers:c,body:JSON.stringify(f)},p=await Ar(()=>fetch(a,g));if(p.ok){const w=await p.json();return Cr(w)}else throw await Ir("Generate Auth Token",p)}function _u(r,{fid:t}){return`${Tr(r)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(r,t=!1){let o;const a=await Ze(r.appConfig,h=>{if(!Nr(h))throw ye.create("not-registered");const f=h.authToken;if(!t&&ku(f))return h;if(f.requestStatus===1)return o=wu(r,t),h;{if(!navigator.onLine)throw ye.create("app-offline");const g=Cu(h);return o=Su(r,g),g}});return o?await o:a.authToken}async function wu(r,t){let o=await $n(r.appConfig);for(;o.authToken.requestStatus===1;)await Pr(100),o=await $n(r.appConfig);const a=o.authToken;return a.requestStatus===0?zt(r,t):a}function $n(r){return Ze(r,t=>{if(!Nr(t))throw ye.create("not-registered");const o=t.authToken;return Iu(o)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function Su(r,t){try{const o=await bu(r,t),a=Object.assign(Object.assign({},t),{authToken:o});return await Ge(r.appConfig,a),o}catch(o){if(kr(o)&&(o.customData.serverCode===401||o.customData.serverCode===404))await Rr(r.appConfig);else{const a=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await Ge(r.appConfig,a)}throw o}}function Nr(r){return r!==void 0&&r.registrationStatus===2}function ku(r){return r.requestStatus===2&&!Tu(r)}function Tu(r){const t=Date.now();return t<r.creationTime||r.creationTime+r.expiresIn<t+Yc}function Cu(r){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},r),{authToken:t})}function Iu(r){return r.requestStatus===1&&r.requestTime+_r<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eu(r){const t=r,{installationEntry:o,registrationPromise:a}=await qt(t);return a?a.catch(console.error):zt(t).catch(console.error),o.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Au(r,t=!1){const o=r;return await Pu(o),(await zt(o,t)).token}async function Pu(r){const{registrationPromise:t}=await qt(r);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jr="installations",xu="installations-internal",Du=r=>{const t=r.getProvider("app").getImmediate(),o=Ou(t),a=Be(t,"heartbeat");return{app:t,appConfig:o,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},Ru=r=>{const t=r.getProvider("app").getImmediate(),o=Be(t,jr).getImmediate();return{getId:()=>Eu(o),getToken:c=>Au(o,c)}};function Lu(){se(new Z(jr,Du,"PUBLIC")),se(new Z(xu,Ru,"PRIVATE"))}Lu();Q(br,$t);Q(br,$t,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="analytics",Nu="firebase_id",ju="origin",Mu=60*1e3,Bu="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Mr="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(r){return Promise.all(r.map(t=>t.catch(o=>o)))}function Fu(r,t){const o=document.createElement("script");o.src=`${Mr}?l=${r}&id=${t}`,o.async=!0,document.head.appendChild(o)}function Hu(r){let t=[];return Array.isArray(window[r])?t=window[r]:window[r]=t,t}async function $u(r,t,o,a,c,h){const f=a[c];try{if(f)await t[f];else{const p=(await Br(o)).find(w=>w.measurementId===c);p&&await t[p.appId]}}catch(g){q.error(g)}r("config",c,h)}async function Uu(r,t,o,a,c){try{let h=[];if(c&&c.send_to){let f=c.send_to;Array.isArray(f)||(f=[f]);const g=await Br(o);for(const p of f){const w=g.find(E=>E.measurementId===p),_=w&&t[w.appId];if(_)h.push(_);else{h=[];break}}}h.length===0&&(h=Object.values(t)),await Promise.all(h),r("event",a,c||{})}catch(h){q.error(h)}}function qu(r,t,o,a){async function c(h,f,g){try{h==="event"?await Uu(r,t,o,f,g):h==="config"?await $u(r,t,o,a,f,g):h==="consent"?r("consent","update",g):r("set",f)}catch(p){q.error(p)}}return c}function zu(r,t,o,a,c){let h=function(...f){window[a].push(arguments)};return window[c]&&typeof window[c]=="function"&&(h=window[c]),window[c]=qu(h,r,t,o),{gtagCore:h,wrappedGtag:window[c]}}function Vu(r){const t=window.document.getElementsByTagName("script");for(const o of Object.values(t))if(o.src&&o.src.includes(Mr)&&o.src.includes(r))return o;return null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ku=30,Gu=1e3;class Ju{constructor(t={},o=Gu){this.throttleMetadata=t,this.intervalMillis=o}getThrottleMetadata(t){return this.throttleMetadata[t]}setThrottleMetadata(t,o){this.throttleMetadata[t]=o}deleteThrottleMetadata(t){delete this.throttleMetadata[t]}}const Fr=new Ju;function Xu(r){return new Headers({Accept:"application/json","x-goog-api-key":r})}async function Yu(r){var t;const{appId:o,apiKey:a}=r,c={method:"GET",headers:Xu(a)},h=Bu.replace("{app-id}",o),f=await fetch(h,c);if(f.status!==200&&f.status!==304){let g="";try{const p=await f.json();!((t=p.error)===null||t===void 0)&&t.message&&(g=p.error.message)}catch{}throw W.create("config-fetch-failed",{httpStatus:f.status,responseMessage:g})}return f.json()}async function Qu(r,t=Fr,o){const{appId:a,apiKey:c,measurementId:h}=r.options;if(!a)throw W.create("no-app-id");if(!c){if(h)return{measurementId:h,appId:a};throw W.create("no-api-key")}const f=t.getThrottleMetadata(a)||{backoffCount:0,throttleEndTimeMillis:Date.now()},g=new tl;return setTimeout(async()=>{g.abort()},o!==void 0?o:Mu),Hr({appId:a,apiKey:c,measurementId:h},f,g,t)}async function Hr(r,{throttleEndTimeMillis:t,backoffCount:o},a,c=Fr){var h;const{appId:f,measurementId:g}=r;try{await Zu(a,t)}catch(p){if(g)return q.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${g} provided in the "measurementId" field in the local Firebase config. [${p==null?void 0:p.message}]`),{appId:f,measurementId:g};throw p}try{const p=await Yu(r);return c.deleteThrottleMetadata(f),p}catch(p){const w=p;if(!el(w)){if(c.deleteThrottleMetadata(f),g)return q.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${g} provided in the "measurementId" field in the local Firebase config. [${w==null?void 0:w.message}]`),{appId:f,measurementId:g};throw p}const _=Number((h=w==null?void 0:w.customData)===null||h===void 0?void 0:h.httpStatus)===503?Dn(o,c.intervalMillis,Ku):Dn(o,c.intervalMillis),E={throttleEndTimeMillis:Date.now()+_,backoffCount:o+1};return c.setThrottleMetadata(f,E),q.debug(`Calling attemptFetch again in ${_} millis`),Hr(r,E,a,c)}}function Zu(r,t){return new Promise((o,a)=>{const c=Math.max(t-Date.now(),0),h=setTimeout(o,c);r.addEventListener(()=>{clearTimeout(h),a(W.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}function el(r){if(!(r instanceof _e)||!r.customData)return!1;const t=Number(r.customData.httpStatus);return t===429||t===500||t===503||t===504}class tl{constructor(){this.listeners=[]}addEventListener(t){this.listeners.push(t)}abort(){this.listeners.forEach(t=>t())}}async function nl(r,t,o,a,c){if(c&&c.global){r("event",o,a);return}else{const h=await t,f=Object.assign(Object.assign({},a),{send_to:h});r("event",o,f)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{constructor(t){this.app=t}_delete(){return delete Oe[this.app.options.appId],Promise.resolve()}}let Oe={},Un=[];const qn={};let wt="dataLayer",sl="gtag",zn,$r,Vn=!1;function al(){const r=[];if(Ma()&&r.push("This is a browser extension environment."),hr()||r.push("Cookies are not available."),r.length>0){const t=r.map((a,c)=>`(${c+1}) ${a}`).join(" "),o=W.create("invalid-analytics-context",{errorInfo:t});q.warn(o.message)}}function cl(r,t,o){al();const a=r.options.appId;if(!a)throw W.create("no-app-id");if(!r.options.apiKey)if(r.options.measurementId)q.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${r.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw W.create("no-api-key");if(Oe[a]!=null)throw W.create("already-exists",{id:a});if(!Vn){Hu(wt);const{wrappedGtag:h,gtagCore:f}=zu(Oe,Un,qn,wt,sl);$r=h,zn=f,Vn=!0}return Oe[a]=il(r,Un,qn,t,zn,wt,o),new ol(r)}function ul(r=vr()){r=Me(r);const t=Be(r,Je);return t.isInitialized()?t.getImmediate():ll(r)}function ll(r,t={}){const o=Be(r,Je);if(o.isInitialized()){const c=o.getImmediate();if(We(t,o.getOptions()))return c;throw W.create("already-initialized")}return o.initialize({options:t})}function hl(r,t,o,a){r=Me(r),nl($r,Oe[r.app.options.appId],t,o,a).catch(c=>q.error(c))}const Wn="@firebase/analytics",Kn="0.9.1";function fl(){se(new Z(Je,(t,{options:o})=>{const a=t.getProvider("app").getImmediate(),c=t.getProvider("installations-internal").getImmediate();return cl(a,c,o)},"PUBLIC")),se(new Z("analytics-internal",r,"PRIVATE")),Q(Wn,Kn),Q(Wn,Kn,"esm2017");function r(t){try{const o=t.getProvider(Je).getImmediate();return{logEvent:(a,c,h)=>hl(o,a,c,h)}}catch(o){throw W.create("interop-component-reg-failed",{reason:o})}}}fl();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dl="/firebase-messaging-sw.js",pl="/firebase-cloud-messaging-push-scope",Ur="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",gl="https://fcmregistrations.googleapis.com/v1",qr="google.c.a.c_id",vl="google.c.a.c_l",yl="google.c.a.ts",ml="google.c.a.e";var Gn;(function(r){r[r.DATA_MESSAGE=1]="DATA_MESSAGE",r[r.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Gn||(Gn={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ie(r){const t=new Uint8Array(r);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function bl(r){const t="=".repeat((4-r.length%4)%4),o=(r+t).replace(/\-/g,"+").replace(/_/g,"/"),a=atob(o),c=new Uint8Array(a.length);for(let h=0;h<a.length;++h)c[h]=a.charCodeAt(h);return c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl="firebase-messaging-database",Tl=1,be="firebase-messaging-store";let kt=null;function Vt(){return kt||(kt=Ye(kl,Tl,{upgrade:(r,t)=>{switch(t){case 0:r.createObjectStore(be)}}})),kt}async function zr(r){const t=Kt(r),a=await(await Vt()).transaction(be).objectStore(be).get(t);if(a)return a;{const c=await wl(r.appConfig.senderId);if(c)return await Wt(r,c),c}}async function Wt(r,t){const o=Kt(r),c=(await Vt()).transaction(be,"readwrite");return await c.objectStore(be).put(t,o),await c.done,t}async function Cl(r){const t=Kt(r),a=(await Vt()).transaction(be,"readwrite");await a.objectStore(be).delete(t),await a.done}function Kt({appConfig:r}){return r.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl=7*24*60*60*1e3;async function Ol(r){const t=await Rl(r.swRegistration,r.vapidKey),o={vapidKey:r.vapidKey,swScope:r.swRegistration.scope,endpoint:t.endpoint,auth:ie(t.getKey("auth")),p256dh:ie(t.getKey("p256dh"))},a=await zr(r.firebaseDependencies);if(a){if(Ll(a.subscriptionOptions,o))return Date.now()>=a.createTime+Pl?Dl(r,{token:a.token,createTime:Date.now(),subscriptionOptions:o}):a.token;try{await Vr(r.firebaseDependencies,a.token)}catch(c){console.warn(c)}return Xn(r.firebaseDependencies,o)}else return Xn(r.firebaseDependencies,o)}async function xl(r){const t=await zr(r.firebaseDependencies);t&&(await Vr(r.firebaseDependencies,t.token),await Cl(r.firebaseDependencies));const o=await r.swRegistration.pushManager.getSubscription();return o?o.unsubscribe():!0}async function Dl(r,t){try{const o=await Al(r.firebaseDependencies,t),a=Object.assign(Object.assign({},t),{token:o,createTime:Date.now()});return await Wt(r.firebaseDependencies,a),o}catch(o){throw await xl(r),o}}async function Xn(r,t){const a={token:await El(r,t),createTime:Date.now(),subscriptionOptions:t};return await Wt(r,a),a.token}async function Rl(r,t){const o=await r.pushManager.getSubscription();return o||r.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:bl(t)})}function Ll(r,t){const o=t.vapidKey===r.vapidKey,a=t.endpoint===r.endpoint,c=t.auth===r.auth,h=t.p256dh===r.p256dh;return o&&a&&c&&h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yn(r){const t={from:r.from,collapseKey:r.collapse_key,messageId:r.fcmMessageId};return Nl(t,r),jl(t,r),Ml(t,r),t}function Nl(r,t){if(!t.notification)return;r.notification={};const o=t.notification.title;o&&(r.notification.title=o);const a=t.notification.body;a&&(r.notification.body=a);const c=t.notification.image;c&&(r.notification.image=c);const h=t.notification.icon;h&&(r.notification.icon=h)}function jl(r,t){!t.data||(r.data=t.data)}function Ml(r,t){var o,a,c,h,f;if(!t.fcmOptions&&!(!((o=t.notification)===null||o===void 0)&&o.click_action))return;r.fcmOptions={};const g=(c=(a=t.fcmOptions)===null||a===void 0?void 0:a.link)!==null&&c!==void 0?c:(h=t.notification)===null||h===void 0?void 0:h.click_action;g&&(r.fcmOptions.link=g);const p=(f=t.fcmOptions)===null||f===void 0?void 0:f.analytics_label;p&&(r.fcmOptions.analyticsLabel=p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bl(r){return typeof r=="object"&&!!r&&qr in r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hl{constructor(t,o,a){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const c=Fl(t);this.firebaseDependencies={app:t,appConfig:c,installations:o,analyticsProvider:a}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $l(r){try{r.swRegistration=await navigator.serviceWorker.register(dl,{scope:pl}),r.swRegistration.update().catch(()=>{})}catch(t){throw H.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ul(r,t){if(!t&&!r.swRegistration&&await $l(r),!(!t&&!!r.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw H.create("invalid-sw-registration");r.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ql(r,t){t?r.vapidKey=t:r.vapidKey||(r.vapidKey=Ur)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gr(r,t){if(!navigator)throw H.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw H.create("permission-blocked");return await ql(r,t==null?void 0:t.vapidKey),await Ul(r,t==null?void 0:t.serviceWorkerRegistration),Ol(r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zl(r,t,o){const a=Vl(t);(await r.firebaseDependencies.analyticsProvider.get()).logEvent(a,{message_id:o[qr],message_name:o[vl],message_time:o[yl],message_device_time:Math.floor(Date.now()/1e3)})}function Vl(r){switch(r){case Ne.NOTIFICATION_CLICKED:return"notification_open";case Ne.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wl(r,t){const o=t.data;if(!o.isFirebaseMessaging)return;r.onMessageHandler&&o.messageType===Ne.PUSH_RECEIVED&&(typeof r.onMessageHandler=="function"?r.onMessageHandler(Yn(o)):r.onMessageHandler.next(Yn(o)));const a=o.data;Bl(a)&&a[ml]==="1"&&await zl(r,o.messageType,a)}const Qn="@firebase/messaging",Zn="0.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kl=r=>{const t=new Hl(r.getProvider("app").getImmediate(),r.getProvider("installations-internal").getImmediate(),r.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",o=>Wl(t,o)),t},Gl=r=>{const t=r.getProvider("messaging").getImmediate();return{getToken:a=>Gr(t,a)}};function Jl(){se(new Z("messaging",Kl,"PUBLIC")),se(new Z("messaging-internal",Gl,"PRIVATE")),Q(Qn,Zn),Q(Qn,Zn,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xl(){try{await Ft()}catch{return!1}return typeof window<"u"&&Bt()&&hr()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yl(r,t){if(!navigator)throw H.create("only-available-in-window");return r.onMessageHandler=t,()=>{r.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ql(r=vr()){return Xl().then(t=>{if(!t)throw H.create("unsupported-browser")},t=>{throw H.create("indexed-db-unsupported")}),Be(Me(r),"messaging").getImmediate()}async function Zl(r,t){return r=Me(r),Gr(r,t)}function eh(r,t){return r=Me(r),Yl(r,t)}Jl();const th={apiKey:"AIzaSyDK6yPqneJ5TafOA_AySHcCw0wps_F8CPE",authDomain:"agroarca-equipamentos.firebaseapp.com",projectId:"agroarca-equipamentos",messagingSenderId:"260002359203",appId:"1:260002359203:web:8c19a187bf2fe28079dc16",measurementId:"G-DHSLGFC76R"},nh="BPlE43kDpMP4nb3ltOOZZRDDxkJA-CKsdim6elA8c5amJmykNZl-_UmxsRGJGe1P3I0R50Qgwyf7Tlaf9ICUcqU";let ae;class rh{constructor(){x(this,"app");x(this,"messaging");x(this,"analytics");x(this,"contexto");this.app=gr(th),this.messaging=Ql(this.app),this.analytics=ul(this.app)}solicitarPermissao(){return new Promise((t,o)=>{if(Notification.permission==="denied"){o();return}if(Notification.permission==="granted"){t();return}Notification.requestPermission().then(a=>{if(Notification.permission==="granted"){t();return}o()})})}iniciarNotificacoes(){this.contexto="app",Lt(()=>{this.solicitarPermissao().then(this.registrarListeners)})}iniciarServiceWorker(){this.contexto="worker",Notification.permission==="granted"&&this.registrarListeners()}registrarListeners(){Zl(ae.messaging,{vapidKey:nh}).then(t=>{t&&ae.salvarToken(t)}),eh(ae.messaging,ae.onMessage)}salvarToken(t){console.log("token:"),console.log(t)}onMessage(t){this.notificar(this.contexto+" onMessage "+JSON.stringify(t))}notificar(t){new Notification(t)}}function ih(){return ae||(ae=new rh,ae)}function oh(){Ta(),ih().iniciarNotificacoes()}const sh={class:"toast-header"},ah={class:"me-auto"},ch=Pe("button",{type:"button",class:"btn-close","data-bs-dismiss":"toast","aria-label":"Close"},null,-1),uh={class:"toast-body"},lh={__name:"Notificacao",props:["id","titulo","texto"],setup(r){const t=r,o=Nt(null);let a;Lt(()=>{a=new ta(o.value),a.show({autohide:!1})});function c(){er.visit(route("site.notificacao",[t.id]))}return(h,f)=>(ge(),Re("div",{class:"toast notificacao",ref_key:"toast",ref:o,role:"alert",onClick:c},[Pe("div",sh,[Pe("span",ah,En(r.titulo),1),ch]),Pe("div",uh,En(r.texto),1)],512))}};class hh{constructor(t,o=10){x(this,"priority");x(this,"callback");this.priority=o,this.callback=t}}const fh={class:"toast-container position-fixed top-0 end-0 p-3"},dh=na({__name:"Notificacoes",setup(r){oh();let t=Nt([]);ke.addListener(new hh(o));function o(a){t.value.push(a.notificacao),setTimeout(()=>{const c=t.value.indexOf(a.notificacao);t.value.splice(c,1)},1e5)}return(a,c)=>(ge(),Re("div",fh,[(ge(!0),Re(tr,null,ra(rr(t),h=>(ge(),nr(lh,ia(oa(h)),null,16))),256))]))}}),bh={__name:"BaseLayout",setup(r){return er.on("navigate",t=>{document.body.classList.remove("admin"),document.body.classList.remove("site"),route().current("admin.*")?document.body.classList.add("admin"):document.body.classList.add("site")}),(t,o)=>(ge(),Re(tr,null,[sa(dh),aa(t.$slots,"default")],64))}},ph={key:0,class:"loader"},gh=Pe("div",{class:"elemento"},null,-1),vh=[gh],_h={__name:"Loader",setup(r){let t=Nt(!1);function o(){t.value=!0}function a(){t.value=!1}return window.loader={show:o,hide:a,active:t},(c,h)=>(ge(),nr(la,{name:"loader",duration:"300"},{default:ca(()=>[rr(t)?(ge(),Re("div",ph,vh)):ua("",!0)]),_:1}))}},wh=(r,t)=>{const o=r.__vccOpts||r;for(const[a,c]of t)o[a]=c;return o};export{Ae as E,hh as L,wh as _,_h as a,bh as b};
