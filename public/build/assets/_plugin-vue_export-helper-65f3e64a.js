import{d as Ye,r as Ht,o as de,c as lr,w as oa,k as Ae,l as sa,T as aa,a as Ie,j as ca,G as ua,x as hr,J as Rn,H as la,t as Nn,I as ha,F as fa,m as da,K as pa,L as ga,f as va,C as ya}from"./app-1986b170.js";import{r as Qe,t as Pe}from"./index-ac617c56.js";const ma={key:0,class:"loader"},ba=Ie("div",{class:"elemento"},null,-1),_a=[ba],Nh=Ye({__name:"Loader",setup(t){const n=Ht(!1);function o(){n.value=!0}function a(){n.value=!1}return window.loader={show:o,hide:a,active:n},(c,h)=>(de(),lr(aa,{name:"loader",duration:"300"},{default:oa(()=>[n.value?(de(),Ae("div",ma,_a)):sa("",!0)]),_:1}))}});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const au="firebase-installations-database",cu=1,ve="firebase-installations-store";let kt=null;function Vt(){return kt||(kt=et(au,cu,{upgrade:(t,n)=>{switch(n){case 0:t.createObjectStore(ve)}}})),kt}async function qe(t,n){const o=tt(t),c=(await Vt()).transaction(ve,"readwrite"),h=c.objectStore(ve),f=await h.get(o);return await h.put(n,o),await c.done,(!f||f.fid!==n.fid)&&Lr(t,n.fid),n}async function Mr(t){const n=tt(t),a=(await Vt()).transaction(ve,"readwrite");await a.objectStore(ve).delete(n),await a.done}async function nt(t,n){const o=tt(t),c=(await Vt()).transaction(ve,"readwrite"),h=c.objectStore(ve),f=await h.get(o),p=n(f);return p===void 0?await h.delete(o):await h.put(p,o),await c.done,p&&(!f||f.fid!==p.fid)&&Lr(t,p.fid),p}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class el{constructor(n){this.app=n}_delete(){return delete Ee[this.app.options.appId],Promise.resolve()}}let Ee={},Wn=[];const Kn={};let Ct="dataLayer",tl="gtag",Gn,Vr,Jn=!1;function nl(){const t=[];if(Da()&&t.push("This is a browser extension environment."),gr()||t.push("Cookies are not available."),t.length>0){const n=t.map((a,c)=>`(${c+1}) ${a}`).join(" "),o=V.create("invalid-analytics-context",{errorInfo:n});U.warn(o.message)}}function rl(t,n,o){nl();const a=t.options.appId;if(!a)throw V.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)U.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw V.create("no-api-key");if(Ee[a]!=null)throw V.create("already-exists",{id:a});if(!Jn){Lu(Ct);const{wrappedGtag:h,gtagCore:f}=Fu(Ee,Wn,Kn,Ct,tl);Vr=h,Gn=f,Jn=!0}return Ee[a]=Zu(t,Wn,Kn,n,Gn,Ct,o),new el(t)}function il(t=_r()){t=Ze(t);const n=Re(t,ze);return n.isInitialized()?n.getImmediate():ol(t)}function ol(t,n={}){const o=Re(t,ze);if(o.isInitialized()){const c=o.getImmediate();if($e(n,o.getOptions()))return c;throw V.create("already-initialized")}return o.initialize({options:n})}function sl(t,n,o,a){t=Ze(t),Yu(Vr,Ee[t.app.options.appId],n,o,a).catch(c=>U.error(c))}const Xn="@firebase/analytics",Yn="0.9.4";function al(){oe(new Q(ze,(n,{options:o})=>{const a=n.getProvider("app").getImmediate(),c=n.getProvider("installations-internal").getImmediate();return rl(a,c,o)},"PUBLIC")),oe(new Q("analytics-internal",t,"PRIVATE")),Y(Xn,Yn),Y(Xn,Yn,"esm2017");function t(n){try{const o=n.getProvider(ze).getImmediate();return{logEvent:(a,c,h)=>sl(o,a,c,h)}}catch(o){throw V.create("interop-component-reg-failed",{reason:o})}}}al();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
