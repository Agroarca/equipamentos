...
class AlterarCategoriaRequest extends FormRequest
{
    ...
    public function getCaracteristicas(): Collection
    {
        if (!$this->caracteristicas) {
            ...
            $categoria = Categoria::findOrFail($this->route('categoriaId'));

            $this->caracteristicas = $this
                ->getEquipCaracService()
                ->getCaracteristicasAlterarCategoria($equipamento, $categoria)['novas'];
        }
